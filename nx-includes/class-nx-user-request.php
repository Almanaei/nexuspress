<?php
/**
 * NX_User_Request class.
 *
 * Represents user request data loaded from a NX_Post object.
 *
 * @since 4.9.6
 */
#[AllowDynamicProperties]
final class NX_User_Request {
	/**
	 * Request ID.
	 *
	 * @since 4.9.6
	...
	public function __construct( $post ) {
		...
		$this->confirmed_timestamp = (int) get_post_meta( $post->ID, '_nx_user_request_confirmed_timestamp', true );
		$this->completed_timestamp = (int) get_post_meta( $post->ID, '_nx_user_request_completed_timestamp', true );
