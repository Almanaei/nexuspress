...
function render_block_core_site_logo( $attributes ) {
	...
	add_filter( 'nx_get_attachment_image_src', $adjust_width_height_filter );

	$custom_logo = get_custom_logo();

	remove_filter( 'nx_get_attachment_image_src', $adjust_width_height_filter );
	...
	if ( $attributes['isLink'] && '_blank' === $attributes['linkTarget'] ) {
		...
		$processor = new NX_HTML_Tag_Processor( $custom_logo );
