import * as __WEBPACK_EXTERNAL_MODULE__nexuspress_interactivity_8e89b257__ from "@nexuspress/interactivity";
/******/ // The require scope
...
;// CONCATENATED MODULE: external "@nexuspress/interactivity"
var x = (y) => {
	var x = {}; __webpack_require__.d(x, y); return x
} 
var y = (x) => (() => (x))
const interactivity_namespaceObject = x({ ["getContext"]: () => (__WEBPACK_EXTERNAL_MODULE__nexuspress_interactivity_8e89b257__.getContext), ["getElement"]: () => (__WEBPACK_EXTERNAL_MODULE__nexuspress_interactivity_8e89b257__.getElement), ["store"]: () => (__WEBPACK_EXTERNAL_MODULE__nexuspress_interactivity_8e89b257__.store) });
;// CONCATENATED MODULE: ./node_modules/@nexuspress/block-library/build-module/image/view.js
/**
 * NexusPress dependencies
 */
...
const {
  ...
  callbacks: {
    setOverlayStyles() {
      ...
      state.overlayStyles = `
				:root {
					--nx--lightbox-initial-top-position: ${screenPosY}px;
					--nx--lightbox-initial-left-position: ${screenPosX}px;
					--nx--lightbox-container-width: ${containerWidth + 1}px;
					--nx--lightbox-container-height: ${containerHeight + 1}px;
					--nx--lightbox-image-width: ${lightboxImgWidth}px;
					--nx--lightbox-image-height: ${lightboxImgHeight}px;
					--nx--lightbox-scale: ${containerScale};
					--nx--lightbox-scrollbar-width: ${window.innerWidth - document.documentElement.clientWidth}px;
				}
			`;
    },
    setButtonStyles() {
