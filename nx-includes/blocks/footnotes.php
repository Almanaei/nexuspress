 ...
 */
function nx_add_footnotes_to_revision( $fields ) {
	$fields['footnotes'] = __( 'Footnotes' );
	return $fields;
}
add_filter( '_nx_post_revision_fields', 'nx_add_footnotes_to_revision' );
 ...
 */
function nx_get_footnotes_from_revision( $revision_field, $field, $revision ) {
	return get_metadata( 'post', $revision->ID, $field, true );
}
add_filter( '_nx_post_revision_field_footnotes', 'nx_get_footnotes_from_revision', 10, 3 );
