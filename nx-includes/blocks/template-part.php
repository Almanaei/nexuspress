...
function render_block_core_template_part( $attributes ) {
	...
	if ( isset( $attributes['slug'] ) && get_stylesheet() === $theme ) {
		...
		$template_part_query = new NX_Query(
			array(
				'post_type'           => 'nx_template_part',
				'post_status'         => 'publish',
		...
		if ( $template_part_post ) {
			 ...
			 * @param array   $attributes         The block attributes.
			 * @param NX_Post $template_part_post The template part post object.
			...
			if ( 0 === validate_file( $attributes['slug'] ) ) {
				$block_template = get_block_file_template( $template_part_id, 'nx_template_part' );
				...
				$block_template_file = _get_block_template_file( 'nx_template_part', $attributes['slug'] );
	...
	$content = nx_filter_content_tags( $content, "template_part_{$area}" );
