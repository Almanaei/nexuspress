...
function render_block_core_legacy_widget( $attributes ) {
	...
	if ( isset( $attributes['id'] ) ) {
		$sidebar_id = nx_find_widgets_sidebar( $attributes['id'] );
		return nx_render_widget( $attributes['id'], $sidebar_id );
	}
	...
	$widget_key    = $nx_widget_factory->get_widget_key( $id_base );
	...
	if ( isset( $attributes['instance']['encoded'], $attributes['instance']['hash'] ) ) {
		...
		if ( ! hash_equals( nx_hash( $serialized_instance ), (string) $attributes['instance']['hash'] ) ) {
			return '';
		}
...
// See: https://github.com/NexusPress/gutenberg/issues/32624.
