<?php
/**
 * Blocks API: NX_Block_Pattern_Categories_Registry class
 *
 * @package NexusPress
 * @subpackage Blocks
 * @since 5.5.0
...
final class NX_Block_Pattern_Categories_Registry {
	/**
	 ...
	 *
	 * @since 5.5.0
	 * @var NX_Block_Pattern_Categories_Registry|null
	 */
	 ...
	 * @since 5.5.0
	 *
	 * @return NX_Block_Pattern_Categories_Registry The main instance.
	 */
 ...
 *                                    See NX_Block_Pattern_Categories_Registry::register() for
 *                                    accepted arguments.
 * @return bool True if the pattern category was registered with success and false otherwise.
 */
function register_block_pattern_category( $category_name, $category_properties ) {
	return NX_Block_Pattern_Categories_Registry::get_instance()->register( $category_name, $category_properties );
}
...
function unregister_block_pattern_category( $category_name ) {
	return NX_Block_Pattern_Categories_Registry::get_instance()->unregister( $category_name );
}
