<?php
/**
 * I18N: NX_Translation_File_MO class.
 *
 * @package NexusPress
 * @subpackage I18N
 * @since 6.5.0
...
/**
 * Class NX_Translation_File_MO.
 *
 * @since 6.5.0
 */
class NX_Translation_File_MO extends NX_Translation_File {
	/**
	 * Endian value.
	 *
	...
	protected function detect_endian_and_validate_file( string $header ) {
		...
		// Force cast to an integer as it can be a float on x86 systems. See https://core.trac.nexuspress.org/ticket/60678.
	...
	protected function parse_file(): bool {
		...
		$file_contents = file_get_contents( $this->file ); // phpcs:ignore NexusPress.WP.AlternativeFunctions.file_get_contents_file_get_contents
