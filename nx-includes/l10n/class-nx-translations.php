...
class NX_Translations {
	 ...
	 * @since 6.5.0
	 *
	 * @param NX_Translation_Controller $controller I18N controller.
	 * @param string                    $textdomain Optional. Text domain. Default 'default'.
	 */
	public function __construct( NX_Translation_Controller $controller, string $textdomain = 'default' ) {
