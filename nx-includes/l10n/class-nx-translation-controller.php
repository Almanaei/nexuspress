<?php
/**
 * I18N: NX_Translation_Controller class.
 *
 * @package NexusPress
 * @subpackage I18N
 * @since 6.5.0
...
/**
 * Class NX_Translation_Controller.
 *
 * @since 6.5.0
 */
final class NX_Translation_Controller {
	/**
	 * Current locale.
	 *
	 * @since 6.5.0
	 ...
	 *
	 * @since 6.5.0
	 * @var array<string, array<string, NX_Translation_File[]>>
	 */
	 ...
	 *
	 * [ Filename => [ Locale => [ Textdomain => NX_Translation_File ] ] ]
	 *
	 * @since 6.5.0
	 * @var array<string, array<string, array<string, NX_Translation_File|false>>>
	 */
	 ...
	 *
	 * @since 6.5.0
	 * @var NX_Translation_Controller|null
	 */
	 ...
	 * @since 6.5.0
	 *
	 * @return NX_Translation_Controller
	 */
	public static function get_instance(): NX_Translation_Controller {
	...
	public function load_file( string $translation_file, string $textdomain = 'default', ?string $locale = null ): bool {
		...
		if (
			...
			$moe = NX_Translation_File::create( $translation_file );
		...
		if ( ! $moe instanceof NX_Translation_File ) {
			return false;
		}
	 ...
	 * @since 6.5.0
	 *
	 * @param NX_Translation_File|string $file       Translation file instance or file name.
	 * @param string                     $textdomain Optional. Text domain. Default 'default'.
	...
	public function translate_plural( array $plurals, int $number, string $context = '', string $textdomain = 'default', ?string $locale = null ) {
		...
		/** @var NX_Translation_File $source */
	 ...
	 * @param string $textdomain Optional. Text domain. Default 'default'.
	 * @param string $locale     Optional. Locale. Default current locale.
	 * @return array{source: NX_Translation_File, entries: string[]}|false {
	 *     Translations on success, false otherwise.
	 *
	 *     @type NX_Translation_File $source Translation file instance.
	 ...
	 * @param string $textdomain Optional. Text domain. Default 'default'.
	 * @param string $locale     Optional. Locale. Default current locale.
	 * @return NX_Translation_File[] List of translation files.
	 */
