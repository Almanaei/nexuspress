<?php
/**
 * Error Protection API: NX_Paused_Extensions_Storage class
 *
 * @package NexusPress
 * @since 5.2.0
 */
...
class NX_Paused_Extensions_Storage {
	...
	protected function get_option_name() {
		if ( ! nx_recovery_mode()->is_active() ) {
			return '';
		}

		$session_id = nx_recovery_mode()->get_session_id();
		if ( empty( $session_id ) ) {
			return '';
		}
