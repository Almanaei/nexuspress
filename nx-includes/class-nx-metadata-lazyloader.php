<?php
/**
 * Meta API: NX_Metadata_Lazyloader class
 *
 * @package NexusPress
 * @subpackage Meta
 * @since 4.5.0
 ...
 *
 * When loading many objects of a given type, such as posts in a NX_Query loop, it often makes
 ...
 *
 * WP uses the NX_Metadata_Lazyloader class to queue objects for metadata cache priming. The class
 * then detects the relevant get_*_meta() function call, and queries the metadata of all queued objects.
 *
 * Do not access this class directly. Use the nx_metadata_lazyloader() function.
 *
 * @since 4.5.0
 */
#[AllowDynamicProperties]
class NX_Metadata_Lazyloader {
	/**
	 ...
	 * @return void|NX_Error NX_Error on failure.
	 */
	public function queue_objects( $object_type, $object_ids ) {
		if ( ! isset( $this->settings[ $object_type ] ) ) {
			return new NX_Error( 'invalid_object_type', __( 'Invalid object type.' ) );
		}
		 ...
		 * @param NX_Metadata_Lazyloader $lazyloader  The lazy-loader object.
		 */
	 ...
	 *
	 * @since 4.5.0
	 * @deprecated 6.3.0 Use NX_Metadata_Lazyloader::lazyload_meta_callback() instead.
	 *
	...
	public function lazyload_term_meta( $check ) {
		_deprecated_function( __METHOD__, '6.3.0', 'NX_Metadata_Lazyloader::lazyload_meta_callback' );
	 ...
	 * directly, from either inside or outside the `NX_Query` object.
	 *
	 * @since 4.5.0
	 * @deprecated 6.3.0 Use NX_Metadata_Lazyloader::lazyload_meta_callback() instead.
	 *
