 ...
 *
 * @since 2.1.0
 * @since 4.6.0 Moved to its own file from nx-includes/locale.php.
 */
...
class NX_Locale {
	 ...
	 *
	 * @see NX_Locale::init() for how to handle the hack.
	 *
	 * @since 2.1.0
	 * @since 6.2.0 Initialized to an empty array.
	 * @var string[]
	...
	public function init() {
		...
		if ( isset( $GLOBALS['text_direction'] ) ) {
			...
			/* translators: 'rtl' or 'ltr'. This sets the text direction for NexusPress. */
	 ...
	 * on nx-admin/options-general.php to the general POT that would
