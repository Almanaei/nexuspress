<?php
/**
 * Feed API: NX_SimplePie_Sanitize_KSES class
 *
 * @package NexusPress
 * @subpackage Feed
 * @since 4.7.0
...
class NX_SimplePie_Sanitize_KSES extends SimplePie\Sanitize {

	/**
	 * NexusPress SimplePie sanitization using KSES.
	 *
