<?php
/**
 * Blocks API: NX_Block_List class
 *
 * @package NexusPress
 * @since 5.5.0
 */
...
class NX_Block_List implements Iterator, ArrayAccess, Countable {
	 ...
	 * @since 5.5.0
	 *
	 * @param array[]|NX_Block[]     $blocks            Array of parsed block data, or block instances.
	...
	public function __construct( $blocks, $available_context = array(), $registry = null ) {
		if ( ! $registry instanceof NX_Block_Type_Registry ) {
	...
	public function offsetGet( $offset ) {
		...
		if ( isset( $block ) && is_array( $block ) ) {
			$block = new NX_Block( $block, $this->available_context, $this->registry );
