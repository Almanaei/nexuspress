<?php
/**
 * REST API: NX_REST_Response class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 4.4.0
 ...
 */
class NX_REST_Response extends NX_HTTP_Response {
	...
	public function remove_link( $rel, $href = null ) {
		...
		if ( $href ) {
			$this->links[ $rel ] = nx_list_filter( $this->links[ $rel ], array( 'href' => $href ), 'NOT' );
		} else {
			$this->links[ $rel ] = array();
		}
	...
	/**
	 * Retrieves a NX_Error object from the response.
	 *
	 * @since 4.4.0
	 *
	 * @return NX_Error|null NX_Error or null on not an errored response.
	 */
