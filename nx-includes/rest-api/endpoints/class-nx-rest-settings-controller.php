<?php
/**
 * REST API: NX_REST_Settings_Controller class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class NX_REST_Settings_Controller extends NX_REST_Controller {
	 ...
	 *
	 * @param NX_REST_Request $request Full details about the request.
	 * @return array|NX_Error Array on success, or NX_Error object on failure.
	 */
	 ...
	 *
	 * @param NX_REST_Request $request Full details about the request.
	 * @return array|NX_Error Array on success, or error object on failure.
	 */
	public function update_item( $request ) {
		...
		foreach ( $options as $name => $args ) {
			...
			if ( is_null( $request[ $name ] ) ) {
				 ...
				 * database.
				 */
				if ( is_nx_error( rest_validate_value_from_schema( get_option( $args['option_name'], false ), $args['schema'] ) ) ) {
					return new NX_Error(
