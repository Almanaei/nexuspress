<?php
/**
 * Synced patterns REST API: NX_REST_Blocks_Controller class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 5.0.0
 ...
 * Patterns are stored as posts with the nx_block post type.
 *
 * @since 5.0.0
 *
 ...
 */
class NX_REST_Blocks_Controller extends NX_REST_Posts_Controller {
	 ...
	 * @since 5.0.0
	 *
	 * @param NX_Post $post Post object that backs the block.
	 ...
	 *
	 * @since 5.0.0
	 * @since 6.3.0 Adds the `nx_pattern_sync_status` postmeta property to the top level of response.
	 *
	...
	public function filter_response_by_context( $data, $context ) {
		...
		// Add the core nx_pattern_sync_status meta as top level property to the response.
		$data['nx_pattern_sync_status'] = isset( $data['meta']['nx_pattern_sync_status'] ) ? $data['meta']['nx_pattern_sync_status'] : '';
		unset( $data['meta']['nx_pattern_sync_status'] );
		return $data;
	}
