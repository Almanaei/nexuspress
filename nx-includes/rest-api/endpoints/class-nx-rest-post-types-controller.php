<?php
/**
 * REST API: NX_REST_Post_Types_Controller class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class NX_REST_Post_Types_Controller extends NX_REST_Controller {
	 ...
	 *
	 * @param NX_Post_Type    $item    Post type object.
	 * @param NX_REST_Request $request Full details about the request.
	...
	public function prepare_item_for_response( $item, $request ) {
		...
		$taxonomies = nx_list_filter( get_object_taxonomies( $post_type->name, 'objects' ), array( 'show_in_rest' => true ) );
		$taxonomies = nx_list_pluck( $taxonomies, 'name' );
		 ...
		 * @param NX_Post_Type     $post_type The original post type object.
	 ...
	 * @since 6.1.0
	 *
	 * @param NX_Post_Type $post_type The post type.
