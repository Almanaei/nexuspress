<?php
/**
 * REST API: NX_REST_Taxonomies_Controller class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class NX_REST_Taxonomies_Controller extends NX_REST_Controller {
	 ...
	 *
	 * @param NX_REST_Request $request Full details about the request.
	 * @return bool|NX_Error True if the request has read access for the item, otherwise false or NX_Error object.
	 */
	 ...
	 *
	 * @param NX_Taxonomy     $item    Taxonomy data.
	 * @param NX_REST_Request $request Full details about the request.
	...
	public function prepare_item_for_response( $item, $request ) {
		 ...
		 * @param NX_Taxonomy      $item     The original taxonomy object.
	 ...
	 * @since 6.1.0
	 *
	 * @param NX_Taxonomy $taxonomy The taxonomy.
