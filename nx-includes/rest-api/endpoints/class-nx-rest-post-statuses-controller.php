<?php
/**
 * REST API: NX_REST_Post_Statuses_Controller class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class NX_REST_Post_Statuses_Controller extends NX_REST_Controller {
	 ...
	 * @param NX_REST_Request $request Full details about the request.
	 * @return NX_REST_Response Post status data.
	 */
