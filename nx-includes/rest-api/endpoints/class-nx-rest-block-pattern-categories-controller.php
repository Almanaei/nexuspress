<?php
/**
 * REST API: NX_REST_Block_Pattern_Categories_Controller class
 *
 * @package    NexusPress
 * @subpackage REST_API
 * @since      6.0.0
 ...
 */
class NX_REST_Block_Pattern_Categories_Controller extends NX_REST_Controller {
	...
	public function get_items( $request ) {
		$response   = array();
		$categories = NX_Block_Pattern_Categories_Registry::get_instance()->get_all_registered();
