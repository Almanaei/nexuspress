<?php
/**
 * REST API: NX_REST_Controller class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 4.7.0
...
abstract class NX_REST_Controller {
	...
	public function register_routes() {
		_doing_it_wrong(
			'NX_REST_Controller::register_routes',
	 ...
	 * @since 4.7.0
	 *
	 * @param mixed           $item    NexusPress representation of the item.
	 * @param NX_REST_Request $request Request object.
	 * @return NX_REST_Response|NX_Error Response object on success, or NX_Error object on failure.
	 */
	 ...
	 * @since 4.7.0
	 *
	 * @param object          $data_object Data model like NX_Term or NX_Post.
	 * @param NX_REST_Request $request     Full details about the request.
	 * @return true|NX_Error True on success, NX_Error object if a field cannot be updated.
	 */
	 ...
	 * @since 4.7.0
	 *
	 * @global array $nx_rest_additional_fields Holds registered fields, organized by object type.
	 *
	...
	protected function get_additional_fields( $object_type = null ) {
		...
		if ( ! $nx_rest_additional_fields || ! isset( $nx_rest_additional_fields[ $object_type ] ) ) {
			return array();
		}

		return $nx_rest_additional_fields[ $object_type ];
	}
	...
	public function get_fields_for_response( $request ) {
		...
		$requested_fields = nx_parse_list( $request['_fields'] );
	 ...
	 *                       on `EDITABLE` requests. Default NX_REST_Server::CREATABLE.
	 * @return array Endpoint arguments.
	 */
	public function get_endpoint_args_for_item_schema( $method = NX_REST_Server::CREATABLE ) {
	 ...
	 * request object.
	 *
	 * @see https://github.com/NX-API/NX-API/issues/1585
	 *
	 * @todo Remove this in favour of https://core.trac.nexuspress.org/ticket/34659
	 *
