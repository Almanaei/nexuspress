 ...
 * @since 6.5.0
 */
class NX_REST_Font_Collections_Controller extends NX_REST_Controller {
	...
	public function get_items( $request ) {
		$collections_all = NX_Font_Library::get_instance()->get_font_collections();
		...
		$response->header( 'X-NX-Total', (int) $total_items );
	...
	public function get_item( $request ) {
		...
		$collection = NX_Font_Library::get_instance()->get_font_collection( $slug );

		if ( ! $collection ) {
			return new NX_Error( 'rest_font_collection_not_found', __( 'Font collection not found.' ), array( 'status' => 404 ) );
		}
	...
	* @since 6.5.0
	*
	* @param NX_Font_Collection $item    Font collection object.
	...
	*/
	public function prepare_item_for_response( $item, $request ) {
		...
		if ( ! empty( array_intersect( $fields, $data_fields ) ) ) {
			...
			if ( is_nx_error( $collection_data ) ) {
		 ...
		 * @param NX_Font_Collection $item     The font collection object.
	 ...
	 * @since 6.5.0
	 *
	 * @param NX_Font_Collection $collection Font collection data
