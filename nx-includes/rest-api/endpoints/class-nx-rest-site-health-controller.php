<?php
/**
 * REST API: NX_REST_Site_Health_Controller class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 5.6.0
 ...
 */
class NX_REST_Site_Health_Controller extends NX_REST_Controller {
	 ...
	 * @since 5.6.0
	 *
	 * @param NX_Site_Health $site_health An instance of the site health class.
	 */
	public function __construct( $site_health ) {
		$this->namespace = 'nx-site-health/v1';
	...
	/**
	 * Checks that the site can reach the NexusPress.org API.
	 *
	 * @since 5.6.0
	 *
	 * @return array
	...
	public function get_directory_sizes() {
		...
		$sizes_data = NX_Debug_Data::get_sizes();
		...
		if ( isset( $all_sizes['total_size']['debug'] ) && 'not available' === $all_sizes['total_size']['debug'] ) {
			return new NX_Error( 'not_available', __( 'Directory sizes could not be returned.' ), array( 'status' => 500 ) );
		}
	 ...
	 *
	 * The {@see NX_Site_Health} class is defined in NX-Admin, while the REST API operates in a front-end context.
