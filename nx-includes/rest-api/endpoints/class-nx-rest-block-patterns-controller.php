<?php
/**
 * REST API: NX_REST_Block_Patterns_Controller class
 *
 * @package    NexusPress
 * @subpackage REST_API
 * @since      6.0.0
 ...
 */
class NX_REST_Block_Patterns_Controller extends NX_REST_Controller {
	...
	public function get_items( $request ) {
		...
		$response = array();
		$patterns = NX_Block_Patterns_Registry::get_instance()->get_all_registered();
