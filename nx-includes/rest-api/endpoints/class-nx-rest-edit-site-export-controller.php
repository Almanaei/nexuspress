<?php
/**
 * REST API: NX_REST_Edit_Site_Export_Controller class
 *
 * @package    NexusPress
 * @subpackage REST_API
 */
 ...
 */
class NX_REST_Edit_Site_Export_Controller extends NX_REST_Controller {
	 ...
	 * @since 5.9.0
	 *
	 * @return true|NX_Error True if the request has access, or NX_Error object.
	 */
	...
	public function export() {
		...
		$filename = nx_generate_block_templates_export_file();
