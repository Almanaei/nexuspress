<?php
/**
 * REST API: NX_REST_Revisions_Controller class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class NX_REST_Revisions_Controller extends NX_REST_Controller {
	...
	public function __construct( $parent_post_type ) {
		...
		$this->meta              = new NX_REST_Post_Meta_Fields( $parent_post_type );
	}
	...
	public function get_items( $request ) {
		...
		if ( nx_revisions_enabled( $parent ) ) {
		...
		$response->header( 'X-NX-Total', (int) $total_revisions );
	...
	public function delete_item_permissions_check( $request ) {
		...
		if ( ! $response || is_nx_error( $response ) ) {
			return $response;
		}
	...
	public function delete_item( $request ) {
		 ...
		 * @since 4.7.0
		 *
		 * @param NX_Post|false|null $result The revision object (if it was deleted or moved to the Trash successfully)
	 ...
	 * @param NX_Post $post    Post revision object.
