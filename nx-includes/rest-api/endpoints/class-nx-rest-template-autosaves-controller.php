<?php
/**
 * REST API: NX_REST_Template_Autosaves_Controller class.
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 6.4.0
 ...
 * @since 6.4.0
 *
 * @see NX_REST_Autosaves_Controller
 */
class NX_REST_Template_Autosaves_Controller extends NX_REST_Autosaves_Controller {
	/**
	 * Parent post type.
	 *
	 * @since 6.4.0
	 ...
	 * @return NX_Post|NX_Error Autosave post object if ID is valid, NX_Error otherwise.
	 */
	public function get_item( $request ) {
		...
		$autosave = nx_get_post_autosave( $parent->ID );
