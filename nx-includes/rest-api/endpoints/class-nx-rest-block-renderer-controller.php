<?php
/**
 * Block Renderer REST API: NX_REST_Block_Renderer_Controller class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 5.0.0
 ...
 */
class NX_REST_Block_Renderer_Controller extends NX_REST_Controller {
	...
	public function register_routes() {
		register_rest_route(
			...
			array(
				...
				array(
					'methods'             => array( NX_REST_Server::READABLE, NX_REST_Server::CREATABLE ),
					...
					'args'                => array(
						...
						'attributes' => array(
							...
							'validate_callback' => static function ( $value, $request ) {
								$block = NX_Block_Type_Registry::get_instance()->get_registered( $request['name'] );
