<?php
/**
 * REST API: NX_REST_Font_Families_Controller class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 6.5.0
 ...
 * @since 6.5.0
 */
class NX_REST_Font_Families_Controller extends NX_REST_Posts_Controller {
	...
	public function prepare_item_for_response( $item, $request ) {
		 ...
		 * @param NX_Post          $post     Font family post object.
		 * @param NX_REST_Request  $request  Request object.
		 */
		return apply_filters( 'rest_prepare_nx_font_family', $response, $item, $request );
	}
	...
	public function get_collection_params() {
		 ...
		 */
		return apply_filters( 'rest_nx_font_family_collection_params', $query_params );
	}
	...
	public function get_endpoint_args_for_item_schema( $method = NX_REST_Server::CREATABLE ) {
		if ( NX_REST_Server::CREATABLE === $method || NX_REST_Server::EDITABLE === $method ) {
