<?php
/**
 * REST API: NX_REST_Menu_Locations_Controller class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 5.9.0
 ...
 */
class NX_REST_Menu_Locations_Controller extends NX_REST_Controller {
	...
	public function get_item( $request ) {
		...
		if ( ! array_key_exists( $request['location'], $registered_menus ) ) {
			return new NX_Error( 'rest_menu_location_invalid', __( 'Invalid menu location.' ), array( 'status' => 404 ) );
		}
	 ...
	 * @param NX_REST_Request $request Full details about the request.
	 * @return NX_REST_Response Menu location data.
	 */
