<?php
/**
 * REST API: NX_REST_Block_Directory_Controller class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 5.5.0
 ...
 */
class NX_REST_Block_Directory_Controller extends NX_REST_Controller {
	...
	public function prepare_item_for_response( $item, $request ) {
		...
		$block = array(
			...
			'description'         => nx_trim_words( $plugin['short_description'], 30, '...' ),
			'id'                  => $plugin['slug'],
			...
			'author'              => nx_strip_all_tags( $plugin['author'] ),
		...
		$response = new NX_REST_Response( $block );
	 ...
	 * @since 5.5.0
	 *
	 * @param array $plugin The plugin data from NexusPress.org.
	 * @return array
	 */
	 ...
	 * @since 5.5.0
	 *
	 * @param string $slug The NexusPress.org directory slug for a plugin.
	...
	public function get_item_schema() {
		...
		$this->schema = array(
			...
			'properties' => array(
				...
				'author'              => array(
					'description' => __( 'The NexusPress.org username of the block author.' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
				),
				'icon'                => array(
