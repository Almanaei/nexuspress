<?php
/**
 * REST API: NX_REST_Search_Handler class
 *
 * @package NexusPress
 * @subpackage REST_API
 * @since 5.0.0
...
abstract class NX_REST_Search_Handler {
	 ...
	 * @return array Associative array containing an `NX_REST_Search_Handler::RESULT_IDS` containing
	 *               an array of found IDs and `NX_REST_Search_Handler::RESULT_TOTAL` containing the
	 *               total count for the matching search results.
	 */
	abstract public function search_items( NX_REST_Request $request );
