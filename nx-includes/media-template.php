 ...
 * @since 3.9.0
 */
function nx_underscore_audio_template() {
	$audio_types = nx_get_audio_extensions();
	?>
 ...
 * @since 3.9.0
 */
function nx_underscore_video_template() {
	$video_types = nx_get_video_extensions();
	?>
<#  var w_rule = '', classes = [],
...
#>
<div style="{{ w_rule }}" class="nx-video">
<video controls
	class="nx-video-shortcode {{ classes.join( ' ' ) }}"
	<# if ( w ) { #>width="{{ w }}"<# } #>
	<# if ( h ) { #>height="{{ h }}"<# } #>
	<?php
	$props = array(
 ...
 * @since 3.5.0
 */
function nx_print_media_templates() {
	$class = 'media-modal nx-core-ui';
	...
	<script type="text/html" id="tmpl-uploader-inline">
		...
		<?php elseif ( is_multisite() && ! is_upload_space_available() ) : ?>
			<div class="upload-ui">
				...
				<?php
				/** This action is documented in nx-admin/includes/media.php */
	...
	<script type="text/html" id="tmpl-attachment-details-two-column">
		<div class="attachment-media-view {{ data.orientation }}">
			...
			if ( isset( $_GET['error'] ) && 'deprecated' === $_GET['error'] ) {
				nx_admin_notice(
					__( 'The Edit Media screen is deprecated as of NexusPress 6.3. Please use the Media Library instead.' ),
					array(
						'id'                 => 'message',
			...
			<div class="thumbnail thumbnail-{{ data.type }}">
				...
				<# if ( 'audio' === data.type ) { #>
				<div class="nx-media-wrapper nx-audio">
					<audio style="visibility: hidden" controls class="nx-audio-shortcode" width="100%" preload="none">
				...
				#>
				<div style="{{ w_rule }}" class="nx-media-wrapper nx-video">
					<video controls="controls" class="nx-video-shortcode" preload="metadata"
		...
		<div class="attachment-info">
			...
			<div class="actions">
				<# if ( data.link ) { #>
					<?php
					$view_media_text = ( '1' === get_option( 'nx_attachment_pages_enabled' ) ) ? __( 'View attachment page' ) : __( 'View media file' );
					?>
			...
			<div class="embed-media-settings">
				<div class="column-settings">
					...
					<# if ( data.attachment ) { #>
						...
						<# } #>
							<div class="custom-size nx-clearfix<# if ( data.model.size !== 'custom' ) { #> hidden<# } #>">
	...
	<script type="text/html" id="tmpl-audio-details">
		...
		<?php $audio_types = nx_get_audio_extensions(); ?>
	...
	<script type="text/html" id="tmpl-video-details">
		...
		<?php $video_types = nx_get_video_extensions(); ?>
		<div class="media-embed media-embed-details">
			<div class="embed-media-settings embed-video-settings">
				<div class="nx-video-holder">
				<#
				...
				<# _.each( data.attachments, function( attachment, index ) { #>
					<dl class="gallery-item">
						...
						<# if ( attachment.caption ) { #>
							<dd class="nx-caption-text gallery-caption">
