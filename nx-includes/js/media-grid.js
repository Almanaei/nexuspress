...
/**
 * nx.media.controller.EditAttachmentMetadata
 *
 ...
 */
EditAttachmentMetadata = nx.media.controller.State.extend(/** @lends nx.media.controller.EditAttachmentMetadata.prototype */{
	defaults: {
		id:      'edit-attachment',
...
/**
 * nx.media.view.MediaFrame.Manage.Router
 *
 * A router for handling the browser history and application state.
 *
 * @memberOf nx.media.view.MediaFrame.Manage
 *
 * @class
 * @augments Backbone.Router
 */
var Router = Backbone.Router.extend(/** @lends nx.media.view.MediaFrame.Manage.Router.prototype */{
	routes: {
	...
	reset: function() {
		var frame = nx.media.frames.edit;
	...
	editItem: function( query ) {
		this.showItem( query );
		nx.media.frames.edit.content.mode( 'edit-details' );
	}
});
...
var Details = nx.media.view.Attachment.Details,
	TwoColumn;

/**
 * nx.media.view.Attachment.Details.TwoColumn
 *
 * A similar view to media.view.Attachment.Details
 * for use in the Edit Attachment modal.
 *
 * @memberOf nx.media.view.Attachment.Details
 *
 * @class
 * @augments nx.media.view.Attachment.Details
 * @augments nx.media.view.Attachment
 * @augments nx.media.View
 * @augments nx.Backbone.View
 * @augments Backbone.View
 */
TwoColumn = Details.extend(/** @lends nx.media.view.Attachment.Details.TwoColumn.prototype */{
	template: nx.template( 'attachment-details-two-column' ),
...
var Button = nx.media.view.Button,
	DeleteSelected = nx.media.view.DeleteSelectedButton,
	DeleteSelectedPermanently;

/**
 * nx.media.view.DeleteSelectedPermanentlyButton
 *
 ...
 *
 * @class
 * @augments nx.media.view.DeleteSelectedButton
 * @augments nx.media.view.Button
 * @augments nx.media.View
 * @augments nx.Backbone.View
 * @augments Backbone.View
 */
DeleteSelectedPermanently = DeleteSelected.extend(/** @lends nx.media.view.DeleteSelectedPermanentlyButton.prototype */{
	initialize: function() {
...
/**
 * nx.media.view.DeleteSelectedButton
 *
 ...
 * @augments Backbone.View
 */
DeleteSelected = Button.extend(/** @lends nx.media.view.DeleteSelectedButton.prototype */{
	initialize: function() {
	...
	filterChange: function( model ) {
		...
		} else if ( nx.media.view.settings.mediaTrash ) {
...
/**
 * nx.media.view.SelectModeToggleButton
 *
 * @memberOf nx.media.view
 *
 * @class
 ...
 * @augments Backbone.View
 */
SelectModeToggle = Button.extend(/** @lends nx.media.view.SelectModeToggle.prototype */{
	initialize: function() {
...
var View = nx.media.View,
	EditImage = nx.media.view.EditImage,
	Details;

/**
 * nx.media.view.EditImage.Details
 *
 * @memberOf nx.media.view.EditImage
 *
 * @class
 * @augments nx.media.view.EditImage
 * @augments nx.media.View
 * @augments nx.Backbone.View
 * @augments Backbone.View
 */
Details = EditImage.extend(/** @lends nx.media.view.EditImage.Details.prototype */{
...
var Frame = nx.media.view.Frame,
	MediaFrame = nx.media.view.MediaFrame,

	$ = jQuery,
	EditAttachments;

/**
 * nx.media.view.MediaFrame.EditAttachments
 *
 ...
 */
EditAttachments = MediaFrame.extend(/** @lends nx.media.view.MediaFrame.EditAttachments.prototype */{

	className: 'edit-attachment-frame',
	template:  nx.template( 'edit-attachment-frame' ),
	...
	createStates: function() {
		this.states.add([
			new nx.media.controller.EditAttachmentMetadata({
				model:   this.model,
	...
	editMetadataMode: function( contentRegion ) {
		contentRegion.view = new nx.media.view.Attachment.Details.TwoColumn({
			controller: this,
			model:      this.model
		});
		 ...
		 */
		contentRegion.view.views.set( '.attachment-compat', new nx.media.view.AttachmentCompat({
			controller: this,
			model:      this.model
		}) );
	...
	editImageMode: function( contentRegion ) {
		var editImageController = new nx.media.controller.EditImage( {
			model: this.model,
			frame: this
		} );
		// Noop some methods.
		...
		contentRegion.view = new nx.media.view.EditImage.Details( {
			model: this.model,
			frame: this,
...
/**
 * nx.media.view.MediaFrame.Manage
 *
 ...
 * @mixes nx.media.controller.StateMachine
 */
Manage = MediaFrame.extend(/** @lends nx.media.view.MediaFrame.Manage.prototype */{
	/**
	 * @constructs
	 */
	initialize: function() {
		...
		this.$window = $( window );
		this.$adminBar = $( '#nx.dminbar' );
		// Store the Add New button for later reuse in nx.media.view.UploaderInline.
		...
		this.gridRouter = new nx.media.view.MediaFrame.Manage.Router();
	...
	openEditAttachmentModal: function( model ) {
		...
		if ( nx.media.frames.edit ) {
			nx.media.frames.edit.open().trigger( 'refresh', model );
		} else {
			nx.media.frames.edit = nx.media( {
	...
	browseContent: function( contentRegion ) {
		...
		this.browserView = contentRegion.view = new nx.media.view.AttachmentsBrowser({
			controller: this,
	...
	startHistory: function() {
		...
		if ( window.history && window.history.pushState ) {
			...
			Backbone.history.start( {
				root: window._nxMediaGridSettings.adminUrl,
				pushState: true
			} );
		}
	}
...
(() => {
/**
 * @output nx-includes/js/media-grid.js
 */
