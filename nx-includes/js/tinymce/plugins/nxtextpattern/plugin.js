 ...
 * The setting name is `nx.extpattern` and the value is an object containing override arrays for each
 * patterns group. There are three groups: "space", "enter", and "inline". Example (PHP):
 *
 * add_filter( 'tiny_mce_before_init', 'my_mce_init_nx.extpattern' );
 * function my_mce_init_nx.extpattern( $init ) {
 *   $init['nxtextpattern'] = nx_json_encode( array(
 *      'inline' => array(
...
( function( tinymce, setTimeout ) {
	...
	tinymce.PluginManager.add( 'nxtextpattern', function( editor ) {
		var VK = tinymce.util.VK;
		var settings = editor.settings.nxtextpattern || {};
