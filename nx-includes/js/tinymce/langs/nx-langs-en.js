...
( function() {
	...
	tinyMCE.addI18n( lang + ".nexuspress", {
		nx_adv_desc: "Show/Hide Kitchen Sink (Alt + Shift + Z)",
		nx_more_desc: "Insert More Tag (Alt + Shift + T)",
		nx_page_desc: "Insert Page break (Alt + Shift + P)",
		nx_help_desc: "Help (Alt + Shift + H)",
		nx_more_alt: "More...",
		nx_page_alt: "Next page...",
		add_media: "Add Media",
		...
		nx_fullscreen_desc: "Distraction-free writing mode (Alt + Shift + W)"
	});

	tinyMCE.addI18n( lang + ".nxeditimage", {
		edit_img: "Edit Image",
