/**
 * @output nx-includes/js/customize-base.js
 */
...
(function( exports, $ ){
	 ...
	 *
	 * @memberOf nx.customize
	 * @alias nx.customize.Value
	 *
	 * @constructor
	 */
	api.Value = api.Class.extend(/** @lends nx.customize.Value.prototype */{
		/**
	 ...
	 *
	 * @memberOf nx.customize
	 * @alias nx.customize.Values
	 *
	 * @constructor
	 * @augments nx.customize.Class
	 * @mixes nx.customize.Events
	 */
	api.Values = api.Class.extend(/** @lends nx.customize.Values.prototype */{
		 ...
		 *
		 * @param {string|nx.customize.Class} item         - The item instance to add, or the ID for the instance to add.
		 *                                                   When an ID string is supplied, then itemObject must be provided.
		 * @param {nx.customize.Class}        [itemObject] - The item instance when the first argument is an ID string.
		 * @return {nx.customize.Class} The new item's instance, or an existing instance if already added.
		 */
	 ...
	 *
	 * @memberOf nx.customize
	 * @alias nx.customize.Element
	 *
	 * @constructor
	 * @augments nx.customize.Value
	 * @augments nx.customize.Class
	 */
	api.Element = api.Value.extend(/** @lends nx.customize.Element */{
	 ...
	 *
	 * @memberOf nx.customize
	 * @alias nx.customize.Messenger
	 *
	 * @constructor
	 * @augments nx.customize.Class
	 * @mixes nx.customize.Events
	 */
	api.Messenger = api.Class.extend(/** @lends nx.customize.Messenger.prototype */{
		/**
		 * Create a new Value.
		 *
	 ...
	 *
	 * @memberOf nx.customize
	 * @alias nx.customize.Notification
	 *
	 ...
	 */
	api.Notification = api.Class.extend(/** @lends nx.customize.Notification.prototype */{
		...
		render: function() {
			...
			if ( ! notification.template ) {
				notification.template = nx.template( notification.templateId );
			}
	 ...
	 * @access public
	 *
	 * @alias nx.customize.utils.parseQueryString
	 *
	...
	/**
	 * Expose the API publicly on window.nx.customize
	 *
	 * @namespace nx.customize
	 */
