/**
 * @output nx-includes/js/customize-preview-widgets.js
 */

/* global _nxWidgetCustomizerPreviewSettings */
 ...
 * @since 4.5.0
 *
 * @namespace nx.customize.widgetsPreview
 *
 * @param {jQuery} $   The jQuery object.
 * @param {Object} _   The utilities library.
 * @param {Object} nx  Current NexusPress environment instance.
 * @param {Object} api Information from the API.
 *
 * @return {Object} Widget-related variables.
 */
nx.customize.widgetsPreview = nx.customize.WidgetCustomizerPreview = (function( $, _, nx, api ) {
	 ...
	 * @since 4.5.0
	 *
	 * @memberOf nx.customize.widgetsPreview
	 *
	 * @return {void}
	 */
	self.init = function() {
	...
	self.WidgetPartial = api.selectiveRefresh.Partial.extend(/** @lends nx.customize.widgetsPreview.WidgetPartial.prototype */{
		 ...
		 *
		 * @alias nx.customize.widgetsPreview.WidgetPartial
		 * @memberOf nx.customize.widgetsPreview
		 *
		 ...
		 *
		 * @inheritDoc
		 * @param {nx.customize.selectiveRefresh.Placement} placement The placement
		 *                                                            function.
		 *
		 * @return {void}
		 */
	...
	self.SidebarPartial = api.selectiveRefresh.Partial.extend(/** @lends nx.customize.widgetsPreview.SidebarPartial.prototype */{
		 ...
		 *
		 * @memberOf nx.customize.widgetsPreview
		 * @alias nx.customize.widgetsPreview.SidebarPartial
		 *
		 * @param {string} id             The partial's ID.
		 ...
		 * @since 4.5.0
		 *
		 * @return {Array.<nx.customize.selectiveRefresh.Placement>} List of placements
		 *                                                           that were reflowed.
		 */
		 ...
		 *
		 * @return {nx.customize.selectiveRefresh.Partial} The widget instance partial.
		 */
	...
	api.bind( 'preview-ready', function() {
		$.extend( self, _nxWidgetCustomizerPreviewSettings );
		self.init();
	});
