...
$.imgAreaSelect = function (img, options) {
    var
        ...
        /* Image position (relative to vienx.rt) */
        left, top,
    ...
    /*
     * Translate selection coordinates (relative to scaled image) to vienx.rt
     * coordinates (relative to parent element)
     */

    /**
     * Translate selection X to vienx.rt X
     *
     * @param x
     *            Selection X
     * @return Vienx.rt X
    ...
    /**
     * Translate selection Y to vienx.rt Y
     *
     * @param y
     *            Selection Y
     * @return Vienx.rt Y
    ...
    /*
     * Translate vienx.rt coordinates to selection coordinates
     */

    /**
     * Translate vienx.rt X to selection X
     *
     * @param x
     *            Vienx.rt X
     * @return Selection X
    ...
    /**
     * Translate vienx.rt Y to selection Y
     *
     * @param y
     *            Vienx.rt Y
     * @return Selection Y
    ...
    /*
     * Translate event coordinates (relative to document) to vienx.rt
     * coordinates
     */

    /**
     * Get event X and translate it to vienx.rt X
     *
     * @param event
     *            The event object
     * @return Vienx.rt X
    ...
    /**
     * Get event Y and translate it to vienx.rt Y
     *
     * @param event
     *            The event object
     * @return Vienx.rt Y
