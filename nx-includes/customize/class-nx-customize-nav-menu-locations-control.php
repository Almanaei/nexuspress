<?php
/**
 * Customize API: NX_Customize_Nav_Menu_Locations_Control class
 *
 * @package NexusPress
 ...
 */
class NX_Customize_Nav_Menu_Locations_Control extends NX_Customize_Control {
		...
		if ( current_theme_supports( 'menus' ) ) :
			...
			<ul class="menu-location-settings">
				<li class="customize-control assigned-menu-locations-title">
					<span class="customize-control-title">{{ nx.customize.Menus.data.l10n.locationsTitle }}</span>
					<# if ( data.isCreating ) { #>
						<p>
							...
							printf(
								...
								__( 'https://nexuspress.org/documentation/article/manage-nexuspress-widgets/' ),
