<?php
/**
 * Customize API: NX_Customize_Partial class
 *
 * @package NexusPress
 ...
 * This class is analogous of NX_Customize_Control.
 *
 * @since 4.5.0
 */
...
class NX_Customize_Partial {
	 ...
	 * @since 4.5.0
	 *
	 * @see NX_Customize_Partial::render()
	 * @var callable Callback is called with one argument, the instance of
	 *               NX_Customize_Partial. The callback can either echo the
	 ...
	 * @since 4.5.0
	 *
	 * @param NX_Customize_Selective_Refresh $component Customize Partial Refresh plugin instance.
	 ...
	 *                                           Callback is called with one argument, the instance of NX_Customize_Partial.
	 ...
	 * }
	 */
	public function __construct( NX_Customize_Selective_Refresh $component, $id, $args = array() ) {
	...
	final public function render( $container_context = array() ) {
		 ...
		 * @param NX_Customize_Partial $partial           NX_Customize_Setting instance.
	...
	/**
	 * Default callback used when invoking NX_Customize_Control::render().
	 *
	 ...
	 */
	public function render_callback( NX_Customize_Partial $partial, $context = array() ) {
