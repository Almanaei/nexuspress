<?php
/**
 * Customize API: NX_Customize_Media_Control class
 *
 * @package NexusPress
 ...
 */
class NX_Customize_Media_Control extends NX_Customize_Control {
	/**
	 * Control type.
	 *
	 * @since 4.2.0
	 ...
	 *
	 * @since 4.1.0
	 * @since 4.2.0 Moved from NX_Customize_Upload_Control.
	 *
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = nx_parse_args( $this->button_labels, $this->get_default_button_labels() );
	}
		...
		if ( is_object( $this->setting ) ) {
			if ( $this->setting->default ) {
				...
				$default_attachment = array(
					...
					'type'  => $type,
					'icon'  => nx_mime_type_icon( $type, '.svg' ),
					'title' => nx_basename( $this->setting->default ),
				);
			...
			if ( $value && $this->setting->default && $value === $this->setting->default ) {
				...
				$this->json['attachment'] = nx_prepare_attachment_for_js( $value );
			}
		}
	}
	 ...
	 * @since 4.2.0 Moved from NX_Customize_Upload_Control.
	 *
	 * @see NX_Customize_Media_Control::content_template()
	 */
			...
			<div class="attachment-media-view attachment-media-view-{{ data.attachment.type }} {{ data.attachment.orientation }}">
				<div class="thumbnail thumbnail-{{ data.attachment.type }}">
					...
					<# } else if ( 'video' === data.attachment.type ) { #>
						<div class="nx-media-wrapper nx-video">
