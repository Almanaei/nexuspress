<?php
/**
 * Customize API: NX_Customize_Code_Editor_Control class
 *
 * @package NexusPress
 ...
 */
class NX_Customize_Code_Editor_Control extends NX_Customize_Control {
	...
	public function enqueue() {
		$this->editor_settings = nx_enqueue_code_editor(
			array_merge(
				array(
					'type'       => $this->code_type,
					'codemirror' => array(
