<?php
/**
 * Customize API: NX_Customize_Header_Image_Control class
 *
 * @package NexusPress
 ...
 */
class NX_Customize_Header_Image_Control extends NX_Customize_Image_Control {
	...
	public function enqueue() {
		nx_enqueue_media();
		nx_enqueue_script( 'customize-views' );
		...
		nx_localize_script(
			...
			array(
				...
				'nonces'   => array(
					'add'    => nx_create_nonce( 'header-add' ),
					'remove' => nx_create_nonce( 'header-remove' ),
				),
