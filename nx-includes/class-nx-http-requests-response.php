<?php
/**
 * HTTP API: NX_HTTP_Requests_Response class
 *
 * @package NexusPress
 * @subpackage HTTP
 * @since 4.6.0
 ...
 * @since 4.6.0
 *
 * @see NX_HTTP_Response
 */
class NX_HTTP_Requests_Response extends NX_HTTP_Response {
	/**
	 ...
	 * @since 4.6.0
	 *
	 * @return NX_HTTP_Cookie[] List of cookie objects.
	 */
	public function get_cookies() {
		$cookies = array();
		foreach ( $this->response->cookies as $cookie ) {
			$cookies[] = new NX_Http_Cookie(
				array(
					'name'      => $cookie->name,
	...
	/**
	 * Converts the object to a NX_Http response array.
	 *
	 * @since 4.6.0
	 *
	 * @return array NX_Http response array, per NX_Http::request().
	 */
