<?php
/**
 * HTML API: NX_HTML_Stack_Event class
 *
 * @package NexusPress
 * @subpackage HTML-API
 * @since 6.6.0
 ...
 *
 * This class is for internal usage of the NX_HTML_Processor class.
 *
 * @access private
 * @since 6.6.0
 *
...
class NX_HTML_Stack_Event {
	 ...
	 * @since 6.6.0
	 *
	 * @param NX_HTML_Token $token      Token associated with stack event, always an opening token.
	 * @param string        $operation  One of self::PUSH or self::POP.
	 * @param string        $provenance "virtual" or "real".
	 */
	public function __construct( NX_HTML_Token $token, string $operation, string $provenance ) {
		$this->token      = $token;
