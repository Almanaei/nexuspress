<?php
/**
 * HTML API: NX_HTML_Processor_State class
 *
 * @package NexusPress
 * @subpackage HTML-API
 * @since 6.4.0
...
class NX_HTML_Processor_State {
	 ...
	 * @see NX_HTML_Processor_State::$insertion_mode
	 *
	 * @var string
	 */
	 ...
	 *
	 * @var NX_HTML_Active_Formatting_Elements
	 */
	...
	public function __construct() {
		$this->stack_of_open_elements     = new NX_HTML_Open_Elements();
		$this->active_formatting_elements = new NX_HTML_Active_Formatting_Elements();
	}
}
