<?php
/**
 * HTML API: NX_HTML_Active_Formatting_Elements class
 *
 * @package NexusPress
 * @subpackage HTML-API
 * @since 6.4.0
 ...
 */
class NX_HTML_Active_Formatting_Elements {
	/**
	 ...
	 */
	public function contains_node( NX_HTML_Token $token ) {
	 ...
	 * @since 6.4.0
	 *
	 * @return NX_HTML_Token|null Last node in the stack of active formatting elements, if one exists, otherwise null.
	 */
	...
	public function insert_marker(): void {
		$this->push( new NX_HTML_Token( null, 'marker', false ) );
	}
	 ...
	 *
	 * @param NX_HTML_Token $token Push this node onto the stack.
	 */
	public function push( NX_HTML_Token $token ) {
		/*
	 ...
	 * @since 6.4.0
	 *
	 * @param NX_HTML_Token $token Remove this node from the stack, if it's there already.
	 * @return bool Whether the node was found and removed from the stack of active formatting elements.
	 */
	public function remove_node( NX_HTML_Token $token ) {
	 ...
	 * see NX_HTML_Active_Formatting_Elements::walk_up().
	 *
	 * @since 6.4.0
	 */
	 ...
	 * see NX_HTML_Active_Formatting_Elements::walk_down().
	 *
	 * @since 6.4.0
	 */
