<?php
/**
 * HTTP API: NX_Http_Encoding class
 *
 * @package NexusPress
 * @subpackage HTTP
 * @since 4.4.0
...
class NX_Http_Encoding {
	 ...
	 * https://core.trac.nexuspress.org/ticket/18273
	 *
	 * @since 2.8.1
	 *
	 * @link https://core.trac.nexuspress.org/ticket/18273
	...
	public static function accept_encoding( $url, $args ) {
		 ...
		 */
		$type = apply_filters( 'nx_http_accept_encoding', $type, $url, $args );
