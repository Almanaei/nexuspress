<?php
/**
 * Widget API: NX_Widget_RSS class
 *
 * @package NexusPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see NX_Widget
 */
class NX_Widget_RSS extends NX_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $title ) {
			...
			$feed_link = sprintf(
				...
				esc_url( $feed_icon ),
				esc_attr__( 'RSS' ),
				( nx_lazy_loading_enabled( 'img', 'rss_widget_feed_icon' ) ? ' loading="lazy"' : '' )
			);
		...
		nx_widget_rss_output( $rss, $instance );
	...
	public function update( $new_instance, $old_instance ) {
		...
		return nx_widget_rss_process( $new_instance, $testurl );
	}
