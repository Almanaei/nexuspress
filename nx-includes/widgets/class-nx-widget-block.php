<?php
/**
 * Widget API: NX_Widget_Block class
 *
 * @package NexusPress
 * @subpackage Widgets
 * @since 5.8.0
 ...
 * @see NX_Widget
 */
class NX_Widget_Block extends NX_Widget {
	...
	public function widget( $args, $instance ) {
		$instance = nx_parse_args( $instance, $this->default_instance );
		 ...
		 * @param NX_Widget_Block $widget   Current Block widget instance.
		 */
		echo apply_filters(
