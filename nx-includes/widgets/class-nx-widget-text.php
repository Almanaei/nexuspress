<?php
/**
 * Widget API: NX_Widget_Text class
 *
 * @package NexusPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see NX_Widget
 */
class NX_Widget_Text extends NX_Widget {
	...
	public function _register_one( $number = -1 ) {
		 ...
		 */
		add_action( 'admin_footer-widgets.php', array( 'NX_Widget_Text', 'render_control_template_scripts' ) );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 * @since 4.8.1 The `$widget` param may now be a `NX_Widget_Custom_HTML` object in addition to a `NX_Widget_Text` object.
		 *
		 * @param string                               $text     The widget content.
		 * @param array                                $instance Array of settings for the current widget.
		 * @param NX_Widget_Text|NX_Widget_Custom_HTML $widget   Current text or HTML widget instance.
		 */
		...
		if ( $is_visual_text_widget ) {
			 ...
			 * @param string         $text     The widget content.
			 * @param array          $instance Array of settings for the current widget.
			 * @param NX_Widget_Text $widget   Current Text widget instance.
			 */
	 ...
	 * @since 4.9.0
	 *
	 * @see NX_Widget_Media_Video::inject_video_max_width_style()
	 *
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( current_user_can( 'unfiltered_html' ) ) {
			...
			$instance['text'] = nx_kses_post( $new_instance['text'] );
		}
	...
	public function enqueue_preview_scripts() {
		...
		nx_playlist_scripts( 'audio' );
		nx_playlist_scripts( 'video' );
	}
	...
	public function enqueue_admin_scripts() {
		nx_enqueue_editor();
		nx_enqueue_media();
		nx_enqueue_script( 'text-widgets' );
		nx_add_inline_script( 'text-widgets', sprintf( 'nx.textWidgets.idBases.push( %s );', nx_json_encode( $this->id_base ) ) );
		nx_add_inline_script( 'text-widgets', 'nx.textWidgets.init();', 'after' );
	}
	 ...
	 *
	 * @see NX_Widget_Text::render_control_template_scripts()
	...
	public static function render_control_template_scripts() {
		...
		<script type="text/html" id="tmpl-widget-text-control-fields">
			...
			<?php if ( ! in_array( 'text_widget_custom_html', $dismissed_pointers, true ) ) : ?>
				<div hidden class="nx-pointer custom-html-widget-pointer nx-pointer-top">
					<div class="nx-pointer-content">
						...
						<?php endif; ?>
						<div class="nx-pointer-buttons">
							<a class="close" href="#"><?php _e( 'Dismiss' ); ?></a>
						</div>
					</div>
					<div class="nx-pointer-arrow">
						<div class="nx-pointer-arrow-inner"></div>
					</div>
				</div>
			<?php endif; ?>

			<?php if ( ! in_array( 'text_widget_paste_html', $dismissed_pointers, true ) ) : ?>
				<div hidden class="nx-pointer paste-html-pointer nx-pointer-top">
					<div class="nx-pointer-content">
			...
			<p>
				...
				<textarea id="{{ elementIdPrefix }}text" class="widefat text nx-editor-area" style="height: 200px" rows="16" cols="20"></textarea>
			</p>
		</script>
		<?php
	}
