<?php
/**
 * Widget API: NX_Widget_Archives class
 *
 * @package NexusPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see NX_Widget
 */
class NX_Widget_Archives extends NX_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<select id="<?php echo esc_attr( $dropdown_id ); ?>" name="archive-dropdown">
			...
			<?php nx_get_archives( $dropdown_args ); ?>
...
(function() {
	 ...
	 *                            NX_Widget_Archives::form().
	 * @param array $old_instance Old settings for this instance.
	 * @return array Updated settings to save.
	 */
	public function update( $new_instance, $old_instance ) {
		$instance             = $old_instance;
		$new_instance         = nx_parse_args(
			(array) $new_instance,
			array(
				'title'    => '',
				'count'    => 0,
