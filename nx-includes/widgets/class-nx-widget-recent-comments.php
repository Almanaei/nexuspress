<?php
/**
 * Widget API: NX_Widget_Recent_Comments class
 *
 * @package NexusPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see NX_Widget
 */
class NX_Widget_Recent_Comments extends NX_Widget {
	...
	public function __construct() {
		...
		if ( is_active_widget( false, false, $this->id_base ) || is_customize_preview() ) {
			add_action( 'nx_head', array( $this, 'recent_comments_style' ) );
		}
	}
	...
	public function widget( $args, $instance ) {
		...
		$comments = get_comments(
			 ...
			 *
			 * @see NX_Comment_Query::query() for information on accepted arguments.
			 *
