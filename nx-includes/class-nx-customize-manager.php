<?php
/**
 * NexusPress Customize Manager classes
 *
 * @package NexusPress
...
final class NX_Customize_Manager {
	/**
	 ...
	 *
	 * @since 4.5.0
	 * @var NX_Customize_Selective_Refresh
	 */
	public $selective_refresh;

	/**
	 * Registered instances of NX_Customize_Setting.
	 *
	 * @since 3.4.0
	 * @var array
	 */
	...
	/**
	 * Sorted top-level instances of NX_Customize_Panel and NX_Customize_Section.
	 *
	 * @since 4.0.0
	 * @var array
	 */
	...
	/**
	 * Registered instances of NX_Customize_Panel.
	 *
	 * @since 4.0.0
	 * @var array
	 */
	...
	/**
	 * Registered instances of NX_Customize_Section.
	 *
	 * @since 3.4.0
	 * @var array
	 */
	...
	/**
	 * Registered instances of NX_Customize_Control.
	 *
	 * @since 3.4.0
	 * @var array
	 */
	...
	public function __construct( $args = array() ) {
		...
		if ( ! isset( $args['changeset_uuid'] ) ) {
			$args['changeset_uuid'] = nx_generate_uuid4();
		}
		...
		if ( ! isset( $args['theme'] ) ) {
			if ( isset( $_REQUEST['customize_theme'] ) ) {
				$args['theme'] = nx_unslash( $_REQUEST['customize_theme'] );
			} elseif ( isset( $_REQUEST['theme'] ) ) { // Deprecated.
				$args['theme'] = nx_unslash( $_REQUEST['theme'] );
			}
		}
		if ( ! isset( $args['messenger_channel'] ) && isset( $_REQUEST['customize_messenger_channel'] ) ) {
			$args['messenger_channel'] = sanitize_key( nx_unslash( $_REQUEST['customize_messenger_channel'] ) );
		}
		...
		$this->theme               = nx_get_theme( 0 === validate_file( $args['theme'] ) ? $args['theme'] : null );
		...
		require_once ABSPATH . NXINC . '/class-nx-customize-setting.php';
		require_once ABSPATH . NXINC . '/class-nx-customize-panel.php';
		require_once ABSPATH . NXINC . '/class-nx-customize-section.php';
		require_once ABSPATH . NXINC . '/class-nx-customize-control.php';

		require_once ABSPATH . NXINC . '/customize/class-nx-customize-color-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-media-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-upload-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-image-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-background-image-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-background-position-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-cropped-image-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-site-icon-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-header-image-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-theme-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-code-editor-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-widget-area-customize-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-widget-form-customize-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-nav-menu-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-nav-menu-item-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-nav-menu-location-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-nav-menu-name-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-nav-menu-locations-control.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-nav-menu-auto-add-control.php';

		require_once ABSPATH . NXINC . '/customize/class-nx-customize-nav-menus-panel.php';

		require_once ABSPATH . NXINC . '/customize/class-nx-customize-themes-panel.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-themes-section.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-sidebar-section.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-nav-menu-section.php';

		require_once ABSPATH . NXINC . '/customize/class-nx-customize-custom-css-setting.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-filter-setting.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-header-image-setting.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-background-image-setting.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-nav-menu-item-setting.php';
		require_once ABSPATH . NXINC . '/customize/class-nx-customize-nav-menu-setting.php';
		 ...
		 * @since 4.4.0
		 *
		 * @see NX_Customize_Manager::__construct()
		 *
		 * @param string[]             $components Array of core components to load.
		 * @param NX_Customize_Manager $manager    NX_Customize_Manager instance.
		 */
		$components = apply_filters( 'customize_loaded_components', $this->components, $this );

		require_once ABSPATH . NXINC . '/customize/class-nx-customize-selective-refresh.php';
		$this->selective_refresh = new NX_Customize_Selective_Refresh( $this );

		if ( in_array( 'widgets', $components, true ) ) {
			require_once ABSPATH . NXINC . '/class-nx-customize-widgets.php';
			$this->widgets = new NX_Customize_Widgets( $this );
		}

		if ( in_array( 'nav_menus', $components, true ) ) {
			require_once ABSPATH . NXINC . '/class-nx-customize-nav-menus.php';
			$this->nav_menus = new NX_Customize_Nav_Menus( $this );
		}

		add_action( 'setup_theme', array( $this, 'setup_theme' ) );
		add_action( 'nx_loaded', array( $this, 'nx_loaded' ) );

		// Do not spawn cron (especially the alternate cron) while running the Customizer.
		remove_action( 'init', 'nx_cron' );
		...
		add_action( 'nx_ajax_customize_save', array( $this, 'save' ) );
		add_action( 'nx_ajax_customize_trash', array( $this, 'handle_changeset_trash_request' ) );
		add_action( 'nx_ajax_customize_refresh_nonces', array( $this, 'refresh_nonces' ) );
		add_action( 'nx_ajax_customize_load_themes', array( $this, 'handle_load_themes_request' ) );
		...
		add_action( 'nx_ajax_customize_override_changeset_lock', array( $this, 'handle_override_changeset_lock_request' ) );
		add_action( 'nx_ajax_customize_dismiss_autosave_or_lock', array( $this, 'handle_dismiss_autosave_or_lock_request' ) );
		...
		if ( current_user_can( 'install_themes' ) || current_user_can( 'update_themes' ) ) {
			...
			add_action( 'customize_controls_print_footer_scripts', 'nx_print_admin_notice_templates' );
		}
	}
	...
	public function doing_ajax( $action = null ) {
		...
		if ( ! $action ) {
			...
			/*
			 * Note: we can't just use doing_action( "nx_ajax_{$action}" ) because we need
			 * to check before admin-ajax.php gets to that point.
			 */
			return isset( $_REQUEST['action'] ) && nx_unslash( $_REQUEST['action'] ) === $action;
		}
	}

	/**
	 * Custom nx_die wrapper. Returns either the standard message for UI
	 * or the Ajax message.
	 *
	 * @since 3.4.0
	 *
	 * @param string|NX_Error $ajax_message Ajax return.
	 * @param string          $message      Optional. UI message.
	 */
	protected function nx_die( $ajax_message, $message = null ) {
		if ( $this->doing_ajax() ) {
			nx_die( $ajax_message );
		}
		...
		if ( $this->messenger_channel ) {
			ob_start();
			nx_enqueue_scripts();
			nx_print_scripts( array( 'customize-base' ) );

			$settings = array(
				'messengerArgs' => array(
					'channel' => $this->messenger_channel,
					'url'     => nx_customize_url(),
				),
				'error'         => $ajax_message,
			);
			...
			} )( nx.customize, <?php echo nx_json_encode( $settings ); ?> );
			</script>
			<?php
			$message .= nx_get_inline_script_tag( nx_remove_surrounding_empty_script_tags( ob_get_clean() ) );
		}
	...
	/**
	 * Returns the Ajax nx_die() handler if it's a customized request.
	 *
	 * @since 3.4.0
	 * @deprecated 4.7.0
	 *
	 ...
	 */
	public function nx_die_handler() {
		_deprecated_function( __METHOD__, '4.7.0' );

		if ( $this->doing_ajax() || isset( $_POST['customized'] ) ) {
			return '_ajax_nx_die_handler';
		}

		return '_default_nx_die_handler';
	}
	...
	public function setup_theme() {
		...
		if ( isset( $this->_changeset_uuid ) && false !== $this->_changeset_uuid && ! nx_is_uuid( $this->_changeset_uuid ) ) {
			$this->nx_die( -1, __( 'Invalid changeset UUID' ) );
		}

		/*
		 * Clear incoming post data if the user lacks a CSRF token (nonce). Note that the customizer
		 * application will inject the customize_preview_nonce query parameter into all Ajax requests.
		 * For similar behavior elsewhere in NexusPress, see rest_cookie_check_errors() which logs out
		...
		if ( ! current_user_can( 'customize' ) && ! $this->changeset_post_id() ) {
			$this->nx_die( $this->messenger_channel ? 0 : -1, __( 'Non-existent changeset UUID.' ) );
		}
		...
		if ( $this->is_theme_active() ) {
			...
			if ( ! current_user_can( 'switch_themes' ) ) {
				$this->nx_die( -1, __( 'Sorry, you are not allowed to edit theme options on this site.' ) );
			}

			// If the theme has errors while loading, bail.
			if ( $this->theme()->errors() ) {
				$this->nx_die( -1, $this->theme()->errors()->get_error_message() );
			}

			// If the theme isn't allowed per multisite settings, bail.
			if ( ! $this->theme()->is_allowed() ) {
				$this->nx_die( -1, __( 'The requested theme does not exist.' ) );
			}
		}
	...
	public function establish_loaded_changeset() {
		...
		if ( empty( $this->_changeset_uuid ) ) {
			...
			if ( ! $this->branching() && $this->is_theme_active() ) {
				...
				if ( ! empty( $unpublished_changeset_post ) && nx_is_uuid( $unpublished_changeset_post->post_name ) ) {
			...
			if ( empty( $changeset_uuid ) ) {
				$changeset_uuid = nx_generate_uuid4();
			}
	...
	public function after_setup_theme() {
		...
		if ( ! $doing_ajax_or_is_customized && ! validate_current_theme() ) {
			nx_redirect( 'themes.php?broken=true' );
			exit;
		}
	}
	...
	public function start_previewing_theme() {
		...
		if ( ! $this->is_theme_active() ) {
			...
			// @link: https://core.trac.nexuspress.org/ticket/20027
	 ...
	 * @since 4.9.0
	 *
	 * @see NX_Customize_Setting::preview()
	 *
	 * @return bool
	 */
	 ...
	 * @since 4.9.0
	 *
	 * @see NX_Customize_Manager::changeset_data()
	 *
	 ...
	 * @since 4.9.0
	 *
	 * @see NX_Customize_Manager::establish_loaded_changeset()
	 *
	...
	public function branching() {
		 ...
		 *
		 * Since linear changesets are deemed to be more suitable for the majority of NexusPress users,
		 * they are the default. For NexusPress sites that have heavy site management in the Customizer
		 ...
		 * @param NX_Customize_Manager $nx_customize    Manager instance.
		 */
	...
	public function nx_loaded() {
		 ...
		 */
		$this->register_panel_type( 'NX_Customize_Panel' );
		$this->register_panel_type( 'NX_Customize_Themes_Panel' );
		$this->register_section_type( 'NX_Customize_Section' );
		$this->register_section_type( 'NX_Customize_Sidebar_Section' );
		$this->register_section_type( 'NX_Customize_Themes_Section' );
		$this->register_control_type( 'NX_Customize_Color_Control' );
		$this->register_control_type( 'NX_Customize_Media_Control' );
		$this->register_control_type( 'NX_Customize_Upload_Control' );
		$this->register_control_type( 'NX_Customize_Image_Control' );
		$this->register_control_type( 'NX_Customize_Background_Image_Control' );
		$this->register_control_type( 'NX_Customize_Background_Position_Control' );
		$this->register_control_type( 'NX_Customize_Cropped_Image_Control' );
		$this->register_control_type( 'NX_Customize_Site_Icon_Control' );
		$this->register_control_type( 'NX_Customize_Theme_Control' );
		$this->register_control_type( 'NX_Customize_Code_Editor_Control' );
		$this->register_control_type( 'NX_Customize_Date_Time_Control' );

		/**
		 * Fires once NexusPress has loaded, allowing scripts and styles to be initialized.
		 *
		 * @since 3.4.0
		 *
		 * @param NX_Customize_Manager $manager NX_Customize_Manager instance.
	 ...
	 * @return int
	 */
	public function nx_redirect_status( $status ) {
	...
	public function find_changeset_post_id( $uuid ) {
		...
		if ( ! empty( $changeset_post_query->posts ) ) {
			...
			nx_cache_set( $uuid, $changeset_post_id, $cache_group );
			return $changeset_post_id;
		}
	 ...
	 * }
	 * @return NX_Post[] Auto-draft changesets.
	 */
	...
	protected function get_changeset_post_data( $post_id ) {
		...
		if ( $last_error ) {
			return new NX_Error( 'json_parse_error', '', $last_error );
		}
		if ( ! is_array( $changeset_data ) ) {
			return new NX_Error( 'expected_array' );
		}
	...
	public function changeset_data() {
		...
		if ( ! $changeset_post_id ) {
			...
			if ( $this->autosaved() && is_user_logged_in() ) {
				$autosave_post = nx_get_post_autosave( $changeset_post_id, get_current_user_id() );
				if ( $autosave_post ) {
	...
	public function import_theme_starter_content( $starter_content = array() ) {
		...
		$all_post_slugs = array_merge(
			nx_list_pluck( $attachments, 'post_name' ),
			nx_list_pluck( $posts, 'post_name' )
		);
		 ...
		 */
		$post_types = array_filter( array_merge( array( 'attachment' ), nx_list_pluck( $posts, 'post_type' ) ) );

		// Re-use auto-draft starter content posts referenced in the current customized state.
		$existing_starter_content_posts = array();
		if ( ! empty( $starter_content_auto_draft_post_ids ) ) {
			$existing_posts_query = new NX_Query(
				array(
			...
			foreach ( $attachments as $symbol => $attachment ) {
				...
				if ( isset( $existing_starter_content_posts[ 'attachment:' . $attachment['post_name'] ] ) ) {
					...
					if ( empty( $attached_file ) || ! file_exists( $attached_file ) ) {
						...
						$metadata = nx_generate_attachment_metadata( $attachment_post->ID, $attached_file );
						nx_update_attachment_metadata( $attachment_id, $metadata );
				...
				if ( ! $attachment_id ) {
					...
					$temp_file_name = nx_tempnam( nx_basename( $file_path ) );
					...
					$attachment_post_data = array_merge(
						nx_array_slice_assoc( $attachment, array( 'post_title', 'post_content', 'post_excerpt' ) ),
						array(
		...
		if ( ! empty( $posts ) ) {
			foreach ( array_keys( $posts ) as $post_symbol ) {
				...
				if ( ! empty( $posts[ $post_symbol ]['template'] ) ) {
					$posts[ $post_symbol ]['meta_input']['_nx_page_template'] = $posts[ $post_symbol ]['template'];
				}

				$r = $this->nav_menus->insert_auto_draft_post( $posts[ $post_symbol ] );
				if ( $r instanceof NX_Post ) {
					$posts[ $post_symbol ]['ID'] = $r->ID;
				}
			}

			$starter_content_auto_draft_post_ids = array_merge( $starter_content_auto_draft_post_ids, nx_list_pluck( $posts, 'ID' ) );
		}
		...
		foreach ( $theme_mods as $name => $value ) {
			...
			if ( 'header_image' === $name ) {
				...
				$metadata = nx_get_attachment_metadata( $value );
				if ( empty( $metadata ) ) {
					continue;
				}
				$value = array(
					'attachment_id' => $value,
					'url'           => nx_get_attachment_url( $value ),
					'height'        => $metadata['height'],
					'width'         => $metadata['width'],
				);
			} elseif ( 'background_image' === $name ) {
				$value = nx_get_attachment_url( $value );
			}
	...
	protected function prepare_starter_content_attachments( $attachments ) {
		...
		foreach ( $attachments as $symbol => $attachment ) {
			...
			$file_name = nx_basename( $attachment['file'] );

			// Skip file types that are not recognized.
			$checked_filetype = nx_check_filetype( $file_name );
	 ...
	 * 4. Any programmatically-set post values via `NX_Customize_Manager::set_post_value()`.
	 *
	...
	public function unsanitized_post_values( $args = array() ) {
		...
		if ( ! $this->is_theme_active() ) {
			...
			if ( isset( $stashed_theme_mods[ $stylesheet ] ) ) {
				$values = array_merge( $values, nx_list_pluck( $stashed_theme_mods[ $stylesheet ], 'value' ) );
			}
		}
		...
		if ( ! $args['exclude_post_data'] ) {
			if ( ! isset( $this->_post_values ) ) {
				if ( isset( $_POST['customized'] ) ) {
					$post_values = json_decode( nx_unslash( $_POST['customized'] ), true );
				} else {
					$post_values = array();
				}
	 ...
	 *
	 * @see NX_REST_Server::dispatch()
	 * @see NX_REST_Request::sanitize_params()
	 * @see NX_REST_Request::has_valid_params()
	 *
	 * @param NX_Customize_Setting $setting       A NX_Customize_Setting derived object.
	...
	public function post_value( $setting, $default_value = null ) {
		...
		if ( is_nx_error( $valid ) ) {
			return $default_value;
		}

		$value = $setting->sanitize( $value );
		if ( is_null( $value ) || is_nx_error( $value ) ) {
			return $default_value;
		}
	 ...
	 * @since 4.2.0
	 *
	 * @param string $setting_id ID for the NX_Customize_Setting instance.
	...
	public function set_post_value( $setting_id, $value ) {
		 ...
		 *
		 * Fires when the NX_Customize_Manager::set_post_value() method is called.
		 *
		 ...
		 * Fires when the NX_Customize_Manager::set_post_value() method is called.
		 *
		 * This is useful for `NX_Customize_Setting` instances to watch
	...
	public function customize_preview_init() {
		 ...
		 * allowed then the auth cookies would not be sent and NexusPress would
		...
		add_filter( 'nx_headers', array( $this, 'filter_iframe_security_headers' ) );
		...
		add_filter( 'nx_redirect', array( $this, 'add_state_query_params' ) );

		nx_enqueue_script( 'customize-preview' );
		nx_enqueue_style( 'customize-preview' );
		add_action( 'nx_head', array( $this, 'customize_preview_loading_style' ) );
		add_action( 'nx_head', array( $this, 'remove_frameless_preview_messenger_channel' ) );
		add_action( 'nx_footer', array( $this, 'customize_preview_settings' ), 20 );
	 ...
	 *
	 * @see nx_redirect()
	 * @see NX_Customize_Manager::get_allowed_url()
	 *
	 * @param string $url URL.
	 * @return string URL.
	 */
	public function add_state_query_params( $url ) {
		$parsed_original_url = nx_parse_url( $url );
		$is_allowed          = false;
		foreach ( $this->get_allowed_urls() as $allowed_url ) {
			$parsed_allowed_url = nx_parse_url( $allowed_url );
			$is_allowed         = (
	...
	public function remove_frameless_preview_messenger_channel() {
		...
		<?php
		nx_print_inline_script_tag( nx_remove_surrounding_empty_script_tags( ob_get_clean() ) );
	}
	...
	public function customize_preview_settings() {
		...
		$self_url           = empty( $_SERVER['REQUEST_URI'] ) ? home_url( '/' ) : sanitize_url( nx_unslash( $_SERVER['REQUEST_URI'] ) );
		...
		foreach ( $allowed_urls as $allowed_url ) {
			$parsed = nx_parse_url( $allowed_url );
		...
		?>
		<script>
			var _wpCustomizeSettings = <?php echo nx_json_encode( $settings ); ?>;
				...
				foreach ( $this->settings as $id => $setting ) {
					if ( $setting->check_capabilities() ) {
						printf(
							"v[%s] = %s;\n",
							nx_json_encode( $id ),
							nx_json_encode( $setting->js_value() )
						);
					}
				}
				?>
	 ...
	 * @deprecated 4.7.0
	 *
	 * @param callable|null $callback Optional. Value passed through for {@see 'nx_die_handler'} filter.
	 *                                Default null.
	 * @return callable|null Value passed through for {@see 'nx_die_handler'} filter.
	 */
	 ...
	 * to values that pass validation, and values that become null or `NX_Error`
	 * after sanitizing are marked invalid.
	 *
	 * @since 4.6.0
	 *
	 * @see NX_REST_Request::has_valid_params()
	 * @see NX_Customize_Setting::validate()
	 *
	 ...
	 * }
	 * @return array Mapping of setting IDs to return value of validate method calls, either `true` or `NX_Error`.
	 */
	public function validate_setting_values( $setting_values, $options = array() ) {
		$options = nx_parse_args(
			$options,
			array(
		...
		foreach ( $setting_values as $setting_id => $unsanitized_value ) {
			...
			if ( ! $setting ) {
				if ( $options['validate_existence'] ) {
					$validities[ $setting_id ] = new NX_Error( 'unrecognized', __( 'Setting does not exist or is unrecognized.' ) );
				}
				continue;
			}
			if ( $options['validate_capability'] && ! current_user_can( $setting->capability ) ) {
				$validity = new NX_Error( 'unauthorized', __( 'Unauthorized to modify setting due to capability.' ) );
			} else {
			...
			if ( ! is_nx_error( $validity ) ) {
				/** This filter is documented in nx-includes/class-nx-customize-setting.php */
				$late_validity = apply_filters( "customize_validate_{$setting->id}", new NX_Error(), $unsanitized_value, $setting );
				if ( is_nx_error( $late_validity ) && $late_validity->has_errors() ) {
			...
			if ( ! is_nx_error( $validity ) ) {
				...
				if ( is_null( $value ) ) {
					$validity = false;
				} elseif ( is_nx_error( $value ) ) {
					$validity = $value;
				}
			}
			if ( false === $validity ) {
				$validity = new NX_Error( 'invalid_value', __( 'Invalid value.' ) );
			}
	 ...
	 *
	 * Converts `NX_Error` instance into array suitable for passing into the
	 * `nx.customize.Notification` JS model.
	 *
	 * @since 4.6.0
	 *
	 * @param true|NX_Error $validity Setting validity.
	 * @return true|array If `$validity` was a NX_Error, the error codes will be array-mapped
	...
	public function save() {
		if ( ! is_user_logged_in() ) {
			nx_send_json_error( 'unauthenticated' );
		}

		if ( ! $this->is_preview() ) {
			nx_send_json_error( 'not_preview' );
		}

		$action = 'save-customize_' . $this->get_stylesheet();
		if ( ! check_ajax_referer( $action, 'nonce', false ) ) {
			nx_send_json_error( 'invalid_nonce' );
		}
		...
		if ( $is_new_changeset ) {
			if ( ! current_user_can( get_post_type_object( 'customize_changeset' )->cap->create_posts ) ) {
				nx_send_json_error( 'cannot_create_changeset_post' );
			}
		} else {
			if ( ! current_user_can( get_post_type_object( 'customize_changeset' )->cap->edit_post, $changeset_post_id ) ) {
				nx_send_json_error( 'cannot_edit_changeset_post' );
			}
		}

		if ( ! empty( $_POST['customize_changeset_data'] ) ) {
			$input_changeset_data = json_decode( nx_unslash( $_POST['customize_changeset_data'] ), true );
			if ( ! is_array( $input_changeset_data ) ) {
				nx_send_json_error( 'invalid_customize_changeset_data' );
			}
		} else {
		...
		if ( isset( $_POST['customize_changeset_title'] ) ) {
			$changeset_title = sanitize_text_field( nx_unslash( $_POST['customize_changeset_title'] ) );
		}
		...
		if ( isset( $_POST['customize_changeset_status'] ) ) {
			$changeset_status = nx_unslash( $_POST['customize_changeset_status'] );
			if ( ! get_post_status_object( $changeset_status ) || ! in_array( $changeset_status, array( 'draft', 'pending', 'publish', 'future' ), true ) ) {
				nx_send_json_error( 'bad_customize_changeset_status', 400 );
			}
			...
			if ( $is_publish && ! current_user_can( get_post_type_object( 'customize_changeset' )->cap->publish_posts ) ) {
				nx_send_json_error( 'changeset_publish_unauthorized', 403 );
			}
		}
		...
		if ( isset( $_POST['customize_changeset_date'] ) ) {
			$changeset_date = nx_unslash( $_POST['customize_changeset_date'] );
			if ( preg_match( '/^\d\d\d\d-\d\d-\d\d \d\d:\d\d:\d\d$/', $changeset_date ) ) {
				...
				$valid_date = nx_checkdate( $mm, $jj, $aa, $changeset_date );
				if ( ! $valid_date ) {
					nx_send_json_error( 'bad_customize_changeset_date', 400 );
				}
		...
		if ( ! $is_new_changeset ) {
			$lock_user_id = nx_check_post_lock( $this->changeset_post_id() );
		}
		...
		if ( is_nx_error( $r ) ) {
			...
			if ( 'publish' === $response['changeset_status'] || 'trash' === $response['changeset_status'] ) {
				$response['next_changeset_uuid'] = nx_generate_uuid4();
			}
		}
		 ...
		 *                                       event on `nx.customize`.
		 * @param NX_Customize_Manager $manager  NX_Customize_Manager instance.
		 */
		$response = apply_filters( 'customize_save_response', $response, $this );

		if ( is_nx_error( $r ) ) {
			nx_send_json_error( $response );
		} else {
			nx_send_json_success( $response );
		}
	}
	 ...
	 * }
	 *
	 * @return array|NX_Error Returns array on success and NX_Error with array data on error.
	 */
	public function save_changeset_post( $args = array() ) {
		...
		if ( $changeset_post_id ) {
			...
			if ( 'publish' === $existing_status || 'trash' === $existing_status ) {
				return new NX_Error(
					...
					array(
						'next_changeset_uuid' => nx_generate_uuid4(),
					)
				);
			}

			$existing_changeset_data = $this->get_changeset_post_data( $changeset_post_id );
			if ( is_nx_error( $existing_changeset_data ) ) {
				return $existing_changeset_data;
			}
		}

		// Fail if attempting to publish but publish hook is missing.
		if ( 'publish' === $args['status'] && false === has_action( 'transition_post_status', '_nx_customize_publish_changeset' ) ) {
			return new NX_Error( 'missing_publish_callback' );
		}
		...
		if ( $args['date_gmt'] ) {
			...
			if ( ! $is_future_dated ) {
				return new NX_Error( 'not_future_date', __( 'You must supply a future date to schedule.' ) ); // Only future dates are allowed.
			}

			if ( ! $this->is_theme_active() && ( 'future' === $args['status'] || $is_future_dated ) ) {
				return new NX_Error( 'cannot_schedule_theme_switches' ); // This should be allowed in the future, when theme is a regular setting.
			}
			...
			if ( $will_remain_auto_draft ) {
				return new NX_Error( 'cannot_supply_date_for_auto_draft_changeset' );
			}
			...
			if ( mysql2date( 'U', $changeset_post->post_date_gmt, false ) <= mysql2date( 'U', $now, false ) ) {
				return new NX_Error( 'not_future_date', __( 'You must supply a future date to schedule.' ) );
			}
		}
		...
		// Validate autosave param. See _nx_post_revision_fields() for why these fields are disallowed.
		if ( $args['autosave'] ) {
			if ( $args['date_gmt'] ) {
				return new NX_Error( 'illegal_autosave_with_date_gmt' );
			} elseif ( $args['status'] ) {
				return new NX_Error( 'illegal_autosave_with_status' );
			} elseif ( $args['user_id'] && get_current_user_id() !== $args['user_id'] ) {
				return new NX_Error( 'illegal_autosave_with_non_current_user' );
			}
		}

		// The request was made via nx.customize.previewer.save().
		...
		$invalid_setting_count = count( array_filter( $setting_validities, 'is_nx_error' ) );
		...
		if ( $update_transactionally && $invalid_setting_count > 0 ) {
			...
			return new NX_Error( 'transaction_fail', '', $response );
		}
		...
		foreach ( $args['data'] as $setting_id => $setting_params ) {
			...
			if ( isset( $setting_validities[ $setting_id ] ) && is_nx_error( $setting_validities[ $setting_id ] ) ) {
				continue;
			}
		...
		$filter_context = array(
			...
			'previous_data' => is_nx_error( $original_changeset_data ) ? array() : $original_changeset_data,
			'manager'       => $this,
		);
		 ...
		 *     @type NX_Customize_Manager $manager       Manager instance.
		 * }
		 */
		...
		// Gather the data for nx_insert_post()/nx_update_post().
		$post_array = array(
			// JSON_UNESCAPED_SLASHES is only to improve readability as slashes needn't be escaped in storage.
			'post_content' => nx_json_encode( $data, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT ),
		);
		if ( $args['title'] ) {
		...
		add_filter( 'nx_save_post_revision_post_has_changed', array( $this, '_filter_revision_post_has_changed' ), 5, 3 );

		/*
		 * Update the changeset post. The publish_customize_changeset action will cause the settings in the
		 * changeset to be saved via NX_Customize_Setting::save(). Updating a post with publish status will
		 * trigger NX_Customize_Manager::publish_changeset_values().
		 */
		add_filter( 'nx_insert_post_data', array( $this, 'preserve_insert_changeset_post_content' ), 5, 3 );
		if ( $changeset_post_id ) {
			if ( $args['autosave'] && 'auto-draft' !== get_post_status( $changeset_post_id ) ) {
				// See _nx_translate_postdata() for why this is required as it will use the edit_post meta capability.
				add_filter( 'map_meta_cap', array( $this, 'grant_edit_post_capability_for_changeset' ), 10, 4 );

				$post_array['post_ID']   = $post_array['ID'];
				$post_array['post_type'] = 'customize_changeset';

				$r = nx_create_post_autosave( nx_slash( $post_array ) );
				...
				$r = nx_update_post( nx_slash( $post_array ), true );

				// Delete autosave revision for user when the changeset is updated.
				if ( ! empty( $args['user_id'] ) ) {
					$autosave_draft = nx_get_post_autosave( $changeset_post_id, $args['user_id'] );
					if ( $autosave_draft ) {
						nx_delete_post( $autosave_draft->ID, true );
					}
				}
			}
		} else {
			$r = nx_insert_post( nx_slash( $post_array ), true );
			if ( ! is_nx_error( $r ) ) {
				$this->_changeset_post_id = $r; // Update cached post ID for the loaded changeset.
			}
		}
		remove_filter( 'nx_insert_post_data', array( $this, 'preserve_insert_changeset_post_content' ), 5 );

		$this->_changeset_data = null; // Reset so NX_Customize_Manager::changeset_data() will re-populate with updated contents.

		remove_filter( 'nx_save_post_revision_post_has_changed', array( $this, '_filter_revision_post_has_changed' ) );
		...
		if ( is_nx_error( $r ) ) {
			...
			return new NX_Error( 'changeset_post_save_failure', '', $response );
		}
	 ...
	 *
	 * Note that NX_Customize_Manager::validate_setting_values() have already
	 ...
	 * NX_Customize_Setting::sanitize() method when being read out of the
	 * changeset, via NX_Customize_Manager::post_value(), and this sanitized
	 * value will also be sent into NX_Customize_Setting::update() for
	 ...
	 * @param array $unsanitized_postarr An array of slashed yet *unsanitized* and unprocessed post data as originally passed to nx_insert_post().
	 ...
	 *
	 * The following re-formulates the logic from `nx_trash_post()` as done in
	 * `nx_publish_post()`. The reason for bypassing `nx_trash_post()` is that it
	 ...
	 *
	 * @param int|NX_Post $post The changeset post.
	 * @return mixed A NX_Post object for the trashed post or an empty value on failure.
	 */
	public function trash_changeset_post( $post ) {
		...
		$new_status = 'trash';
		$nxdb->update( $nxdb->posts, array( 'post_status' => $new_status ), array( 'ID' => $post->ID ) );
		clean_post_cache( $post->ID );

		$post->post_status = $new_status;
		nx_transition_post_status( $new_status, $previous_status, $post );
		...
		nx_after_insert_post( get_post( $post_id ), true, $post );
	...
	public function handle_changeset_trash_request() {
		...
		if ( $changeset_post_id ) {
			...
			$lock_user = (int) nx_check_post_lock( $changeset_post_id );
	 ...
	 * required in core for `nx_create_post_autosave()` because it will call
	 * `_nx_translate_postdata()` which in turn will check if a user can 'edit_post', but the
	 ...
	 * @since 4.9.0
	 *
	 * @link https://core.trac.nexuspress.org/ticket/40922
	 * @see NX_Customize_Manager::save_changeset_post()
	 * @see _nx_translate_postdata()
	 *
	...
	public function check_changeset_lock_with_heartbeat( $response, $data, $screen_id ) {
		...
		if (
			...
			$lock_user_id = nx_check_post_lock( $changeset_post_id );
	...
	public function handle_override_changeset_lock_request() {
		if ( ! $this->is_preview() ) {
			nx_send_json_error( 'not_preview', 400 );
		}
		...
		nx_send_json_success( 'changeset_taken_over' );
	}
	 ...
	 * @param NX_Post $latest_revision  The latest revision post object.
	 ...
	 * `_nx_customize_publish_changeset()` when a customize_changeset post is
	 * transitioned to the `publish` status. As such, this method should not be
	 * called directly and instead `nx_publish_post()` should be used.
	 *
	 ...
	 * @since 4.7.0
	 *
	 * @see _nx_customize_publish_changeset()
	 * @global nxdb $nxdb NexusPress database abstraction object.
	 *
	 * @param int $changeset_post_id ID for customize_changeset post. Defaults to the changeset for the current manager instance.
	 * @return true|NX_Error True or error info.
	 */
	public function _publish_changeset_values( $changeset_post_id ) {
		...
		if ( is_nx_error( $publishing_changeset_data ) ) {
		 ...
		 * on the $nx_customize object passed to hooks during the save logic.
		 */
		...
		foreach ( $changeset_setting_ids as $setting_id ) {
			...
			if ( $setting ) {
				...
				if ( isset( $setting_user_ids[ $setting_id ] ) ) {
					nx_set_current_user( $setting_user_ids[ $setting_id ] );
				} else {
					nx_set_current_user( $original_user_id );
				}
		 ...
		 */
		$revisions = nx_get_post_revisions( $changeset_post_id, array( 'check_enabled' => false ) );
	...
	public function refresh_nonces() {
		...
		nx_send_json_success( $this->get_nonces() );
	}
	...
	public function handle_dismiss_autosave_or_lock_request() {
		// Calls to dismiss_user_auto_draft_changesets() and nx_get_post_autosave() require non-zero get_current_user_id().
		if ( ! is_user_logged_in() ) {
			nx_send_json_error( 'unauthenticated', 401 );
		}
		...
		if ( ! check_ajax_referer( 'customize_dismiss_autosave_or_lock', 'nonce', false ) ) {
			nx_send_json_error( 'invalid_nonce', 403 );
		}
		...
		if ( $dismiss_autosave ) {
			if ( empty( $changeset_post_id ) || 'auto-draft' === get_post_status( $changeset_post_id ) ) {
				...
				if ( $dismissed > 0 ) {
					nx_send_json_success( 'auto_draft_dismissed' );
				} else {
					nx_send_json_error( 'no_auto_draft_to_delete', 404 );
				}
			} else {
				$revision = nx_get_post_autosave( $changeset_post_id, get_current_user_id() );

				if ( $revision ) {
					if ( ! current_user_can( get_post_type_object( 'customize_changeset' )->cap->delete_post, $changeset_post_id ) ) {
						nx_send_json_error( 'cannot_delete_autosave_revision', 403 );
					}

					if ( ! nx_delete_post( $revision->ID, true ) ) {
						nx_send_json_error( 'autosave_revision_deletion_failure', 500 );
					} else {
						nx_send_json_success( 'autosave_revision_deleted' );
					}
				} else {
					nx_send_json_error( 'no_autosave_revision_to_delete', 404 );
				}
			}
		}

		nx_send_json_error( 'unknown_error', 500 );
	}
	 ...
	 *
	 * @since 3.4.0
	 * @since 4.5.0 Return added NX_Customize_Setting instance.
	 *
	 * @see NX_Customize_Setting::__construct()
	 * @link https://developer.nexuspress.org/themes/customize-api
	 *
	 * @param NX_Customize_Setting|string $id   Customize Setting object, or ID.
	 * @param array                       $args Optional. Array of properties for the new Setting object.
	 *                                          See NX_Customize_Setting::__construct() for information
	 *                                          on accepted arguments. Default empty array.
	 * @return NX_Customize_Setting The instance of the setting that was added.
	 */
	public function add_setting( $id, $args = array() ) {
		if ( $id instanceof NX_Customize_Setting ) {
			$setting = $id;
		} else {
			$class = 'NX_Customize_Setting';

			/** This filter is documented in nx-includes/class-nx-customize-manager.php */
	 ...
	 * on the front end and have been sent to NexusPress in `$_POST['customized']`. When WP
	 ...
	 * @return array The NX_Customize_Setting objects added.
	 */
	public function add_dynamic_settings( $setting_ids ) {
		...
		foreach ( $setting_ids as $setting_id ) {
			...
			$setting_args  = false;
			$setting_class = 'NX_Customize_Setting';
			 ...
			 * the NX_Customize_Setting constructor.
			 *
			 * @since 4.2.0
			 *
			 * @param false|array $setting_args The arguments to the NX_Customize_Setting constructor.
			...
			/**
			 * Allow non-statically created settings to be constructed with custom NX_Customize_Setting subclass.
			 *
			 * @since 4.2.0
			 *
			 * @param string $setting_class NX_Customize_Setting or a subclass.
			 * @param string $setting_id    ID for dynamic setting, usually coming from `$_POST['customized']`.
			 * @param array  $setting_args  NX_Customize_Setting or a subclass.
			 */
	 ...
	 * @return NX_Customize_Setting|void The setting, if set.
	 */
	 ...
	 *
	 * Note that removing the setting doesn't destroy the NX_Customize_Setting instance or remove its filters.
	 *
	 * @since 3.4.0
	 *
	 * @param string $id Customize Setting ID.
	 ...
	 *
	 * @since 4.0.0
	 * @since 4.5.0 Return added NX_Customize_Panel instance.
	 *
	 * @see NX_Customize_Panel::__construct()
	 *
	 * @param NX_Customize_Panel|string $id   Customize Panel object, or ID.
	 * @param array                     $args Optional. Array of properties for the new Panel object.
	 *                                        See NX_Customize_Panel::__construct() for information
	 *                                        on accepted arguments. Default empty array.
	 * @return NX_Customize_Panel The instance of the panel that was added.
	 */
	public function add_panel( $id, $args = array() ) {
		if ( $id instanceof NX_Customize_Panel ) {
			$panel = $id;
		} else {
			$panel = new NX_Customize_Panel( $this, $id, $args );
		}
	 ...
	 * @return NX_Customize_Panel|void Requested panel instance, if set.
	 */
	 ...
	 *
	 * Note that removing the panel doesn't destroy the NX_Customize_Panel instance or remove its filters.
	 *
	 * @since 4.0.0
	 *
		...
		if ( in_array( $id, $this->components, true ) ) {
			_doing_it_wrong(
				...
				sprintf(
					...
					sprintf(
						'<a href="%1$s">%2$s</a>',
						esc_url( 'https://developer.nexuspress.org/reference/hooks/customize_loaded_components/' ),
	 ...
	 * @since 4.3.0
	 *
	 * @see NX_Customize_Panel
	 *
	 * @param string $panel Name of a custom panel which is a subclass of NX_Customize_Panel.
	 */
	 ...
	 *
	 * @since 3.4.0
	 * @since 4.5.0 Return added NX_Customize_Section instance.
	 *
	 * @see NX_Customize_Section::__construct()
	 *
	 * @param NX_Customize_Section|string $id   Customize Section object, or ID.
	 * @param array                       $args Optional. Array of properties for the new Section object.
	 *                                          See NX_Customize_Section::__construct() for information
	 *                                          on accepted arguments. Default empty array.
	 * @return NX_Customize_Section The instance of the section that was added.
	 */
	public function add_section( $id, $args = array() ) {
		if ( $id instanceof NX_Customize_Section ) {
			$section = $id;
		} else {
			$section = new NX_Customize_Section( $this, $id, $args );
		}
	 ...
	 * @return NX_Customize_Section|void The section, if set.
	 */
	 ...
	 *
	 * Note that removing the section doesn't destroy the NX_Customize_Section instance or remove its filters.
	 *
	 * @since 3.4.0
	 *
	 * @param string $id Section ID.
	 ...
	 * @since 4.3.0
	 *
	 * @see NX_Customize_Section
	 *
	 * @param string $section Name of a custom section which is a subclass of NX_Customize_Section.
	 */
	 ...
	 *
	 * @since 3.4.0
	 * @since 4.5.0 Return added NX_Customize_Control instance.
	 *
	 * @see NX_Customize_Control::__construct()
	 *
	 * @param NX_Customize_Control|string $id   Customize Control object, or ID.
	 * @param array                       $args Optional. Array of properties for the new Control object.
	 *                                          See NX_Customize_Control::__construct() for information
	 *                                          on accepted arguments. Default empty array.
	 * @return NX_Customize_Control The instance of the control that was added.
	 */
	public function add_control( $id, $args = array() ) {
		if ( $id instanceof NX_Customize_Control ) {
			$control = $id;
		} else {
			$control = new NX_Customize_Control( $this, $id, $args );
		}
	 ...
	 * @return NX_Customize_Control|void The control object, if set.
	 */
	 ...
	 *
	 * Note that removing the control doesn't destroy the NX_Customize_Control instance or remove its filters.
	 *
	 * @since 3.4.0
	 *
	 * @param string $id ID of the control.
				...
				<div class="notification-message customize-changeset-locked-message {{ data.lockUser.avatar ? 'has-avatar' : '' }}">
					...
					<p class="action-buttons">
						...
						<# if ( data.allowOverride ) { #>
							<button class="button button-primary nx-tab-last customize-notice-take-over-button"><?php _e( 'Take over' ); ?></button>
						<# } #>
					</p>
				</div>
			</li>
	 ...
	 *
	 * @since 3.4.0
	 * @deprecated 4.7.0 Use nx_list_sort()
	 *
	 * @param NX_Customize_Panel|NX_Customize_Section|NX_Customize_Control $a Object A.
	 * @param NX_Customize_Panel|NX_Customize_Section|NX_Customize_Control $b Object B.
	 * @return int
	 */
	protected function _cmp_priority( $a, $b ) {
		_deprecated_function( __METHOD__, '4.7.0', 'nx_list_sort' );
	...
	public function is_ios() {
		return nx_is_mobile() && preg_match( '/iPad|iPod|iPhone/', $_SERVER['HTTP_USER_AGENT'] );
	}
	...
	public function set_preview_url( $preview_url ) {
		...
		$this->preview_url = nx_validate_redirect( $preview_url, home_url( '/' ) );
	}
	...
	public function is_cross_domain() {
		$admin_origin = nx_parse_url( admin_url() );
		$home_origin  = nx_parse_url( home_url() );
	...
	public function set_return_url( $return_url ) {
		...
		$return_url       = remove_query_arg( nx_removable_query_args(), $return_url );
		$return_url       = nx_validate_redirect( $return_url );
	...
	public function get_return_url() {
		...
		$referer                    = nx_get_referer();
		$excluded_referer_basenames = array( 'customize.php', 'nx-login.php' );

		if ( $this->return_url ) {
			$return_url = $this->return_url;

			$return_url_basename = nx_basename( parse_url( $this->return_url, PHP_URL_PATH ) );
		...
		} elseif ( $referer && ! in_array( nx_basename( parse_url( $referer, PHP_URL_PATH ) ), $excluded_referer_basenames, true ) ) {
			$return_url = $referer;
	...
	public function set_autofocus( $autofocus ) {
		$this->autofocus = array_filter( nx_array_slice_assoc( $autofocus, array( 'panel', 'section', 'control' ) ), 'is_string' );
	}
	...
	public function get_nonces() {
		$nonces = array(
			'save'                     => nx_create_nonce( 'save-customize_' . $this->get_stylesheet() ),
			'preview'                  => nx_create_nonce( 'preview-customize_' . $this->get_stylesheet() ),
			'switch_themes'            => nx_create_nonce( 'switch_themes' ),
			'dismiss_autosave_or_lock' => nx_create_nonce( 'customize_dismiss_autosave_or_lock' ),
			'override_lock'            => nx_create_nonce( 'customize_override_changeset_lock' ),
			'trash'                    => nx_create_nonce( 'trash_customize_changeset' ),
		);
	...
	public function customize_pane_settings() {
		...
		if ( ! $this->saved_starter_content_changeset && ! $this->autosaved() ) {
			if ( $changeset_post_id ) {
				if ( is_user_logged_in() ) {
					$autosave_revision_post = nx_get_post_autosave( $changeset_post_id, get_current_user_id() );
				}
			} else {
		...
		<script>
			...
			foreach ( $this->settings() as $setting ) {
				if ( $setting->check_capabilities() ) {
					printf(
						"s[%s] = %s;\n",
						nx_json_encode( $setting->id ),
						nx_json_encode( $setting->json() )
					);
				}
			}
			...
			foreach ( $this->controls() as $control ) {
				if ( $control->check_capabilities() ) {
					printf(
						"c[%s] = %s;\n",
						nx_json_encode( $control->id ),
						nx_json_encode( $control->json() )
					);
				}
			}
	...
	public function get_previewable_devices() {
		 ...
		 * @since 4.5.0
		 *
		 * @see NX_Customize_Manager::get_previewable_devices()
		 *
	...
	public function register_controls() {
		...
		$this->add_panel(
			new NX_Customize_Themes_Panel(
				$this,
				'themes',
				array(
					'title'       => $this->theme()->display( 'Name' ),
					'description' => (
					'<p>' . __( 'Looking for a theme? You can search or browse the NexusPress.org theme directory, install and preview themes, then activate them right here.' ) . '</p>' .
		...
		$this->add_section(
			new NX_Customize_Themes_Section(
				$this,
				'installed_themes',
				array(
		...
		if ( ! is_multisite() ) {
			$this->add_section(
				new NX_Customize_Themes_Section(
					...
					'wporg_themes',
					array(
						'title'       => __( 'NexusPress.org themes' ),
						'action'      => 'wporg',
						'filter_type' => 'remote',
		...
		$this->add_setting(
			new NX_Customize_Filter_Setting(
				$this,
				'active_theme',
				array(
					'capability' => 'switch_themes',
		...
		$this->add_control(
			new NX_Customize_Site_Icon_Control(
				$this,
				'site_icon',
				array(
					'label'       => __( 'Site Icon' ),
					'description' => sprintf(
						...
						'<p>' . __( 'The Site Icon is what you see in browser tabs, bookmark bars, and within the NexusPress mobile apps. It should be square and at least <code>%1$s by %2$s</code> pixels.' ) . '</p>',
						512,
						512
					),
					'section'     => 'title_tagline',
		...
		$this->add_control(
			new NX_Customize_Cropped_Image_Control(
				$this,
				'custom_logo',
				array(
					'label'         => __( 'Logo' ),
		...
		$this->add_control(
			new NX_Customize_Color_Control(
				$this,
				'header_textcolor',
				array(
		...
		$this->add_setting(
			new NX_Customize_Header_Image_Setting(
				$this,
				'header_image_data',
				array(
					'theme_supports' => 'custom-header',
		...
		$this->add_control(
			new NX_Customize_Media_Control(
				$this,
				'header_video',
				array(
					'theme_supports'  => array( 'custom-header', 'video' ),
		...
		$this->add_control( new NX_Customize_Header_Image_Control( $this ) );

		$this->selective_refresh->add_partial(
			'custom_header',
			array(
				'selector'            => '#nx-custom-header',
		...
		$this->add_setting(
			new NX_Customize_Background_Image_Setting(
				$this,
		...
		$this->add_control( new NX_Customize_Background_Image_Control( $this ) );
		...
		$this->add_control(
			new NX_Customize_Background_Position_Control(
				$this,
				'background_position',
				array(
		 ...
		 */
		if ( get_theme_support( 'custom-background', 'nx-head-callback' ) === '_custom_background_cb' ) {
		...
		/*
		 * Static Front Page
		 * See also https://core.trac.nexuspress.org/ticket/19627 which introduces the static-front-page theme_support.
		...
		$section_description .= sprintf(
			...
			esc_url( __( 'https://developer.nexuspress.org/advanced-administration/nexuspress/css/' ) ),
		...
		if ( 'false' !== nx_get_current_user()->syntax_highlighting ) {
			$section_description .= '<p>';
			$section_description .= sprintf(
		...
		$custom_css_setting = new NX_Customize_Custom_CSS_Setting(
			$this,
		...
		$this->add_control(
			new NX_Customize_Code_Editor_Control(
				$this,
				'custom_css',
				array(
					'label'       => __( 'CSS code' ),
	...
	public function handle_load_themes_request() {
		...
		if ( empty( $_POST['theme_action'] ) ) {
			nx_send_json_error( 'missing_theme_action' );
		}
		...
		if ( ! array_key_exists( 'search', $_POST ) ) {
			...
			$args['search'] = sanitize_text_field( nx_unslash( $_POST['search'] ) );
		}

		if ( ! array_key_exists( 'tags', $_POST ) ) {
			$args['tag'] = '';
		} else {
			$args['tag'] = array_map( 'sanitize_text_field', nx_unslash( (array) $_POST['tags'] ) );
		}
		...
		if ( 'installed' === $theme_action ) {
			...
			// Load all installed themes from nx_prepare_themes_for_js().
			$themes = array( 'themes' => array() );
			foreach ( nx_prepare_themes_for_js() as $theme ) {
			...
			// Load NexusPress.org themes from the .org API and normalize data to match installed theme objects.
			...
			if ( is_nx_error( $themes ) ) {
				nx_send_json_error();
			}

			// This list matches the allowed tags in nx-admin/includes/theme-install.php.
			...
			$nx_themes        = nx_get_themes();
			foreach ( $nx_themes as $theme ) {
				$installed_themes[] = $theme->get_stylesheet();
			}
			$update_php = network_admin_url( 'update.php?action=install-theme' );

			// Set up properties for themes available on NexusPress.org.
			foreach ( $themes->themes as &$theme ) {
				$theme->install_url = add_query_arg(
					array(
						'theme'    => $theme->slug,
						'_wpnonce' => nx_create_nonce( 'install-theme_' . $theme->slug ),
					),
					$update_php
				);

				$theme->name        = nx_kses( $theme->name, $themes_allowedtags );
				$theme->version     = nx_kses( $theme->version, $themes_allowedtags );
				$theme->description = nx_kses( $theme->description, $themes_allowedtags );
				$theme->stars       = nx_star_rating(
					array(
						'rating' => $theme->rating,
						'type'   => 'percent',
				...
				$theme->authorAndUri  = nx_kses( $theme->author['display_name'], $themes_allowedtags );
				$theme->compatibleWP  = is_nx_version_compatible( $theme->requires ); // phpcs:ignore NexusPress.NamingConventions.ValidVariableName
				$theme->compatiblePHP = is_php_version_compatible( $theme->requires_php ); // phpcs:ignore NexusPress.NamingConventions.ValidVariableName
		 ...
		 * or modification of data loaded from `nx_prepare_themes_for_js()`
		 * or NexusPress.org via `themes_api()`.
		 *
		 * @since 4.9.0
		 *
		 * @see nx_prepare_themes_for_js()
		 * @see themes_api()
		 * @see NX_Customize_Manager::__construct()
		 *
		 * @param array|stdClass       $themes  Nested array or object of theme data.
		 * @param array                $args    List of arguments, such as page, search term, and tags to query for.
		 * @param NX_Customize_Manager $manager Instance of Customize manager.
		 */
		$themes = apply_filters( 'customize_load_themes', $themes, $args, $this );

		nx_send_json_success( $themes );
	}
	 ...
	 * @param NX_Customize_Setting $setting Setting.
	 * @return string|NX_Error Background value or validation error.
	 */
	public function _sanitize_background_setting( $value, $setting ) {
		if ( 'background_repeat' === $setting->id ) {
			if ( ! in_array( $value, array( 'repeat-x', 'repeat-y', 'repeat', 'no-repeat' ), true ) ) {
				return new NX_Error( 'invalid_value', __( 'Invalid value for background repeat.' ) );
			}
		} elseif ( 'background_attachment' === $setting->id ) {
			if ( ! in_array( $value, array( 'fixed', 'scroll' ), true ) ) {
				return new NX_Error( 'invalid_value', __( 'Invalid value for background attachment.' ) );
			}
		} elseif ( 'background_position_x' === $setting->id ) {
			if ( ! in_array( $value, array( 'left', 'center', 'right' ), true ) ) {
				return new NX_Error( 'invalid_value', __( 'Invalid value for background position X.' ) );
			}
		} elseif ( 'background_position_y' === $setting->id ) {
			if ( ! in_array( $value, array( 'top', 'center', 'bottom' ), true ) ) {
				return new NX_Error( 'invalid_value', __( 'Invalid value for background position Y.' ) );
			}
		} elseif ( 'background_size' === $setting->id ) {
			if ( ! in_array( $value, array( 'auto', 'contain', 'cover' ), true ) ) {
				return new NX_Error( 'invalid_value', __( 'Invalid value for background size.' ) );
			}
			...
			return new NX_Error( 'unrecognized_setting', __( 'Unrecognized background setting.' ) );
		}
		return $value;
	}
	 ...
	 * @param NX_Customize_Selective_Refresh $selective_refresh Selective refresh component.
	 ...
	 * argument.
	 *
	 * @see NX_Customize_Manager::register_controls()
	 *
	 * @since 4.5.0
	 *
