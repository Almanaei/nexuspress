<?php
/**
 * Block Bindings API: NX_Block_Bindings_Registry class.
 *
...
final class NX_Block_Bindings_Registry {
	 ...
	 *
	 * @since 6.5.0
	 * @var NX_Block_Bindings_Registry|null
	 */
	...
	public function register( string $source_name, array $source_properties ) {
		...
		$source = new NX_Block_Bindings_Source(
			$source_name,
			$source_properties
		);
	 ...
	 * @since 6.5.0
	 *
	 * @return NX_Block_Bindings_Source[] The array of registered sources.
	 */
	...
	public function __wakeup() {
		...
		foreach ( $this->sources as $value ) {
			if ( ! $value instanceof NX_Block_Bindings_Source ) {
				throw new UnexpectedValueException();
			}
		}
	}
	 ...
	 * @since 6.5.0
	 *
	 * @return NX_Block_Bindings_Registry The main instance.
	 */
