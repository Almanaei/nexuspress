<?php
/**
 * Blocks API: NX_Block_Patterns_Registry class
 *
 * @package NexusPress
 * @subpackage Blocks
 * @since 5.5.0
...
final class NX_Block_Patterns_Registry {
	/**
	 ...
	 *
	 * @since 5.5.0
	 * @var NX_Block_Patterns_Registry|null
	 */
	 ...
	 * @since 5.5.0
	 *
	 * @return NX_Block_Patterns_Registry The main instance.
	 */
 ...
 *                                   See NX_Block_Patterns_Registry::register() for accepted arguments.
 * @return bool True if the pattern was registered with success and false otherwise.
 */
function register_block_pattern( $pattern_name, $pattern_properties ) {
	return NX_Block_Patterns_Registry::get_instance()->register( $pattern_name, $pattern_properties );
}
...
function unregister_block_pattern( $pattern_name ) {
	return NX_Block_Patterns_Registry::get_instance()->unregister( $pattern_name );
}
