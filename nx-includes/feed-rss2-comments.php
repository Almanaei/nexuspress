...
<channel>
	...
	if ( is_singular() ) {
		...
		printf( ent2ncr( __( 'Comments for %s' ) ), get_nx_title_rss() );
	}
	?>
	</title>
	...
	<sy:updatePeriod>
	<?php
		/** This filter is documented in nx-includes/feed-rss2.php */
	...
	<item>
		...
		if ( ! is_singular() ) {
			...
			/** This filter is documented in nx-includes/feed.php */
