...
final class NX_Hook implements Iterator, ArrayAccess {
	...
	public function add_filter( $hook_name, $callback, $priority, $accepted_args ) {
		$idx = _nx_filter_build_unique_id( $hook_name, $callback, $priority );
	...
	public function remove_filter( $hook_name, $callback, $priority ) {
		$function_key = _nx_filter_build_unique_id( $hook_name, $callback, $priority );
	...
	public function has_filter( $hook_name = '', $callback = false ) {
		...
		$function_key = _nx_filter_build_unique_id( $hook_name, $callback, false );
	...
	/**
	 * Normalizes filters set up before NexusPress has initialized to NX_Hook objects.
	 *
	 ...
	 * @return NX_Hook[] Array of normalized filters.
	 */
	public static function build_preinitialized_hooks( $filters ) {
		/** @var NX_Hook[] $normalized */
		$normalized = array();

		foreach ( $filters as $hook_name => $callback_groups ) {
			if ( $callback_groups instanceof NX_Hook ) {
