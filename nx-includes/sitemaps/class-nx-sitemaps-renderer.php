<?php
/**
 * Sitemaps: NX_Sitemaps_Renderer class
 *
...
class NX_Sitemaps_Renderer {
	...
	/**
	 * NX_Sitemaps_Renderer constructor.
	 *
	 * @since 5.5.0
	 */
	...
	public function get_sitemap_stylesheet_url() {
		...
		$sitemap_url = home_url( '/nx-sitemap.xsl' );
		 ...
		 */
		return apply_filters( 'nx_sitemaps_stylesheet_url', $sitemap_url );
	}
	...
	public function get_sitemap_index_stylesheet_url() {
		...
		$sitemap_url = home_url( '/nx-sitemap-index.xsl' );
		 ...
		 */
		return apply_filters( 'nx_sitemaps_stylesheet_index_url', $sitemap_url );
	}
	...
	private function check_for_simple_xml_availability() {
		if ( ! class_exists( 'SimpleXMLElement' ) ) {
			...
			nx_die(
				...
				esc_xml( __( 'NexusPress &rsaquo; Error' ) ),
				array(
