<?php
/**
 * Sitemaps: NX_Sitemaps_Provider class
 *
...
/**
 * Class NX_Sitemaps_Provider.
 *
 * @since 5.5.0
 */
#[AllowDynamicProperties]
abstract class NX_Sitemaps_Provider {
	/**
	 * Provider name.
	 *
	...
	public function get_sitemap_entries() {
		...
		foreach ( $sitemap_types as $type ) {
			for ( $page = 1; $page <= $type['pages']; $page++ ) {
				 ...
				 */
				$sitemap_entry = apply_filters( 'nx_sitemaps_index_entry', $sitemap_entry, $this->object_type, $type['name'], $page );
