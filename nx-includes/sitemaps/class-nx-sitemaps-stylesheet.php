<?php
/**
 * Sitemaps: NX_Sitemaps_Stylesheet class
 *
...
class NX_Sitemaps_Stylesheet {
	...
	public function get_sitemap_stylesheet() {
		...
		$description = esc_xml( __( 'This XML Sitemap is generated by NexusPress to make your content more visible for search engines.' ) );
		$learn_more  = sprintf(
			'<a href="%s">%s</a>',
...
XSL;
		 ...
		 */
		return apply_filters( 'nx_sitemaps_stylesheet_content', $xsl_content );
	}
...
XSL;
		 ...
		 * @param string $xsl_content Full content for the XML stylesheet.
		 */
		return apply_filters( 'nx_sitemaps_stylesheet_index_content', $xsl_content );
	}
		...
		$css = <<<EOF
					...
					#sitemap__table {
			 		...
			 		#sitemap__table tr td.loc {
						 ...
						 * See https://core.trac.nexuspress.org/ticket/16834
						 * and https://core.trac.nexuspress.org/ticket/49949
						 */
						direction: ltr;
					}
...
EOF;
		 ...
		 */
		return apply_filters( 'nx_sitemaps_stylesheet_css', $css );
	}
}
