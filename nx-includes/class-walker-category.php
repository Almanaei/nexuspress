...
class Walker_Category extends Walker {
	 ...
	 *                       value is 'list'. See nx_list_categories(). Default empty array.
	 */
	 ...
	 *
	 * @param string  $output            Used to append additional content (passed by reference).
	 * @param NX_Term $data_object       Category data object.
	 * @param int     $depth             Optional. Depth of category in reference to parents. Default 0.
	 * @param array   $args              Optional. An array of arguments. See nx_list_categories().
	 *                                   Default empty array.
	...
	public function start_el( &$output, $data_object, $depth = 0, $args = array(), $current_object_id = 0 ) {
		 ...
		 * }
		 * @param NX_Term $category          Term data object.
		...
		if ( 'list' === $args['style'] ) {
			 ...
			 * @param NX_Term  $category    Category data object.
			 * @param int      $depth       Depth of page, used for padding.
			 * @param array    $args        An array of nx_list_categories() arguments.
			 */
	 ...
	 *                            append to output. See nx_list_categories(). Default empty array.
	 */
