<?php
/**
 * Style Engine: NX_Style_Engine_CSS_Declarations class
 *
 * @package NexusPress
...
class NX_Style_Engine_CSS_Declarations {
	 ...
	 * @return NX_Style_Engine_CSS_Declarations Returns the object to allow chaining methods.
	 */
	...
	protected static function filter_declaration( $property, $value, $spacer = '' ) {
		$filtered_value = nx_strip_all_tags( $value, true );
		if ( '' !== $filtered_value ) {
