<?php
/**
 * Style Engine: NX_Style_Engine_CSS_Rules_Store class
 *
 * @package NexusPress
...
/**
 * Core class used as a store for NX_Style_Engine_CSS_Rule objects.
 *
...
class NX_Style_Engine_CSS_Rules_Store {

	/**
	 * An array of named NX_Style_Engine_CSS_Rules_Store objects.
	 *
	 * @static
	 *
	 * @since 6.1.0
	 ...
	 * @return NX_Style_Engine_CSS_Rules_Store|void
	 */
	 ...
	 * @since 6.1.0
	 *
	 * @return NX_Style_Engine_CSS_Rules_Store[]
	 */
	 ...
	 * @since 6.1.0
	 *
	 * @return NX_Style_Engine_CSS_Rule[]
	 */
	...
	/**
	 * Gets a NX_Style_Engine_CSS_Rule object by its selector.
	 ...
	 * @return NX_Style_Engine_CSS_Rule|void Returns a NX_Style_Engine_CSS_Rule object,
	...
	public function add_rule( $selector, $rules_group = '' ) {
		...
		if ( ! empty( $rules_group ) ) {
			if ( empty( $this->rules[ "$rules_group $selector" ] ) ) {
				$this->rules[ "$rules_group $selector" ] = new NX_Style_Engine_CSS_Rule( $selector, array(), $rules_group );
			}
		...
		if ( empty( $this->rules[ $selector ] ) ) {
			$this->rules[ $selector ] = new NX_Style_Engine_CSS_Rule( $selector );
		}
