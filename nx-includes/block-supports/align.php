 ...
 */
function nx_register_alignment_support( $block_type ) {
 ...
 */
function nx_apply_alignment_support( $block_type, $block_attributes ) {
	$attributes        = array();
	$has_align_support = block_has_support( $block_type, 'align', false );
	if ( $has_align_support ) {
...
NX_Block_Supports::get_instance()->register(
	'align',
	array(
		'register_attribute' => 'nx_register_alignment_support',
		'apply'              => 'nx_apply_alignment_support',
	)
);
