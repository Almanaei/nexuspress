 ...
 */
function nx_register_spacing_support( $block_type ) {
 ...
 */
function nx_apply_spacing_support( $block_type, $block_attributes ) {
	if ( nx_should_skip_block_supports_serialization( $block_type, 'spacing' ) ) {
		return array();
	}
	...
	$skip_padding         = nx_should_skip_block_supports_serialization( $block_type, 'spacing', 'padding' );
	$skip_margin          = nx_should_skip_block_supports_serialization( $block_type, 'spacing', 'margin' );
	...
	$styles = nx_style_engine_get_styles( array( 'spacing' => $spacing_block_styles ) );
...
NX_Block_Supports::get_instance()->register(
	'spacing',
	array(
		'register_attribute' => 'nx_register_spacing_support',
		'apply'              => 'nx_apply_spacing_support',
	)
);
