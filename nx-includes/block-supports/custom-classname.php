 ...
 */
function nx_register_custom_classname_support( $block_type ) {
 ...
 */
function nx_apply_custom_classname_support( $block_type, $block_attributes ) {
	$has_custom_classname_support = block_has_support( $block_type, 'customClassName', true );
	$attributes                   = array();
	if ( $has_custom_classname_support ) {
...
NX_Block_Supports::get_instance()->register(
	'custom-classname',
	array(
		'register_attribute' => 'nx_register_custom_classname_support',
		'apply'              => 'nx_apply_custom_classname_support',
	)
);
