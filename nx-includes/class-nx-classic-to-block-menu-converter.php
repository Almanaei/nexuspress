<?php
/**
 * NX_Classic_To_Block_Menu_Converter class
 *
 * @package NexusPress
 * @since 6.3.0
 */
 ...
 * @access public
 */
class NX_Classic_To_Block_Menu_Converter {
	 ...
	 * @since 6.3.0
	 *
	 * @param NX_Term $menu The Menu term object of the menu to convert.
	 * @return string|NX_Error The serialized and normalized parsed blocks on success,
	 *                         an empty string when there are no menus to convert,
	 *                         or NX_Error on invalid menu.
	 */
