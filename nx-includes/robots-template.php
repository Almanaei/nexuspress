 ...
 * {@see 'nx_robots'} filter. The directives are then sanitized, and the
...
function nx_robots() {
	 ...
	 */
	$robots = apply_filters( 'nx_robots', array() );
 ...
 * {@see 'nx_robots'} filter.
 *
 * Typical usage is as a {@see 'nx_robots'} callback:
 *
 *     add_filter( 'nx_robots', 'nx_robots_noindex' );
 *
 * @since 5.7.0
 *
 * @see nx_robots_no_robots()
 *
 * @param array $robots Associative array of robots directives.
 * @return array Filtered robots directives.
 */
function nx_robots_noindex( array $robots ) {
	if ( ! get_option( 'blog_public' ) ) {
		return nx_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function nx_robots_noindex_embeds( array $robots ) {
	if ( is_embed() ) {
		return nx_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function nx_robots_noindex_search( array $robots ) {
	if ( is_search() ) {
		return nx_robots_no_robots( $robots );
	}
 ...
 * @return array Filtered robots directives.
 */
function nx_robots_no_robots( array $robots ) {
	$robots['noindex'] = true;
 ...
 * @return array Filtered robots directives.
 */
function nx_robots_sensitive_page( array $robots ) {
	$robots['noindex']   = true;
 ...
 * @return array Filtered robots directives.
 */
function nx_robots_max_image_preview_large( array $robots ) {
	if ( get_option( 'blog_public' ) ) {
