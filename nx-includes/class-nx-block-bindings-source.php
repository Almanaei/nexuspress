<?php
/**
 * Block Bindings API: NX_Block_Bindings_Source class.
 *
 * @package NexusPress
 ...
 * @access private
 *
 * @see NX_Block_Bindings_Registry
 */
final class NX_Block_Bindings_Source {
	 ...
	 * `NX_Block_Bindings_Registry::register` method or the `register_block_bindings_source` function.
	 *
	 * @since 6.5.0
	 *
