<?php
/**
 * Locale API: NX_Locale_Switcher class
 *
 * @package NexusPress
 * @subpackage i18n
 * @since 4.7.0
...
class NX_Locale_Switcher {
	...
	/**
	 * Filters the locale of the NexusPress installation.
	 *
	 * @since 4.7.0
	 *
	 * @param string $locale The locale of the NexusPress installation.
	 ...
	 *
	 * Loads the translations, changes the global `$nx_locale` object and updates
	...
	private function change_locale( $locale ) {
		...
		NX_Translation_Controller::get_instance()->set_locale( $locale );
