<?php
/**
 * Feed API: NX_Feed_Cache_Transient class
 *
 * @package NexusPress
 * @subpackage Feed
 * @since 4.7.0
...
class NX_Feed_Cache_Transient implements SimplePie\Cache\Base {
	...
	public function __construct( $location, $name, $type ) {
		 ...
		 */
		$this->lifetime = apply_filters( 'nx_feed_cache_transient_lifetime', $lifetime, $name );
	}
