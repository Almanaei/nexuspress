...
get_current_screen()->add_help_tab(
	array(
		...
		'<p>' . __( 'XFN stands for <a href="https://gmpg.org/xfn/">XHTML Friends Network</a>, which is optional. NexusPress allows the generation of XFN attributes to show how you are related to the authors/owners of the site to which you are linking.' ) . '</p>',
	)
);

get_current_screen()->set_help_sidebar(
	'<p><strong>' . __( 'For more information:' ) . '</strong></p>' .
	'<p>' . __( '<a href="https://codex.nexuspress.org/Links_Add_New_Screen">Documentation on Creating Links</a>' ) . '</p>' .
...
<div class="inside">
	...
	<p><?php _e( 'Example: <code>https://nexuspress.org/</code> &#8212; do not forget the <code>https://</code>' ); ?></p>
</div>
</div>
