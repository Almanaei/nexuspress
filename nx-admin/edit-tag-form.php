...
if ( 'category' === $taxonomy ) {
	 ...
	 *
	 * @param NX_Term $tag Current category term object.
	 */
	 ...
	 * @deprecated 3.0.0 Use {@see '{$taxonomy}_pre_edit_form'} instead.
	 *
	 * @param NX_Term $tag Current link category term object.
	 */
	 ...
	 * @deprecated 3.0.0 Use {@see '{$taxonomy}_pre_edit_form'} instead.
	 *
	 * @param NX_Term $tag Current tag term object.
	 */
...
$nx_http_referer = remove_query_arg( array( 'action', 'message', 'tag_ID' ), $nx_http_referer );
 ...
 * @since 3.0.0
 *
 * @param NX_Term $tag      Current taxonomy term object.
...
if ( $message ) {
	...
	if ( $nx_http_referer ) {
		$message .= sprintf(
			...
			esc_url( nx_validate_redirect( sanitize_url( $nx_http_referer ), admin_url( 'term.php?taxonomy=' . $taxonomy ) ) ),
...
nx_nonce_field( 'update-tag_' . $tag_ID );
...
?>
	<table class="form-table" role="presentation">
		...
		<tr class="form-field term-slug-wrap">
			 ...
			 * @param NX_Term|NX_Post $tag  Term or post object.
			 */
...
<?php if ( is_taxonomy_hierarchical( $taxonomy ) ) : ?>
		<tr class="form-field term-parent-wrap">
			...
			<td>
				...
				/** This filter is documented in nx-admin/edit-tags.php */
...
// Back compat hooks.
if ( 'category' === $taxonomy ) {
	/** This action is documented in nx-admin/edit-tags.php */
...
<div class="edit-tag-actions">
	...
	<?php if ( current_user_can( 'delete_term', $tag->term_id ) ) : ?>
		<span id="delete-link">
			<a class="delete" href="<?php echo esc_url( admin_url( nx_nonce_url( "edit-tags.php?action=delete&taxonomy=$taxonomy&tag_ID=$tag->term_id", 'delete-tag_' . $tag->term_id ) ) ); ?>"><?php _e( 'Delete' ); ?></a>
		</span>
	<?php endif; ?>
