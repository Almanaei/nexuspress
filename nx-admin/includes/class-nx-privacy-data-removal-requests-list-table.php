<?php
/**
 * List Table API: NX_Privacy_Data_Removal_Requests_List_Table class
 *
 * @package NexusPress
...
if ( ! class_exists( 'NX_Privacy_Requests_Table' ) ) {
	require_once ABSPATH . 'nx-admin/includes/class-nx-privacy-requests-table.php';
}

/**
 * NX_Privacy_Data_Removal_Requests_List_Table class.
 *
 * @since 4.9.6
 */
class NX_Privacy_Data_Removal_Requests_List_Table extends NX_Privacy_Requests_Table {
	/**
	...
	public function column_email( $item ) {
		...
		if ( 'request-confirmed' !== $status ) {
			...
			$nonce         = nx_create_nonce( 'nx-privacy-erase-personal-data-' . $request_id );
