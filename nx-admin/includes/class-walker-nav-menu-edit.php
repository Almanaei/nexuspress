...
class Walker_Nav_Menu_Edit extends Walker_Nav_Menu {
	 ...
	 * @param NX_Post  $data_object       Menu item data object.
	 * @param int      $depth             Depth of menu item. Used for padding.
	 * @param stdClass $args              Not used.
	...
	public function start_el( &$output, $data_object, $depth = 0, $args = null, $current_object_id = 0 ) {
		...
		$_nx_nav_menu_max_depth = $depth > $_nx_nav_menu_max_depth ? $depth : $_nx_nav_menu_max_depth;
		...
		<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode( ' ', $classes ); ?>">
			...
			<div class="menu-item-settings nx-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
				 ...
				 * @param NX_Post       $menu_item         Menu item data object.
				 * @param int           $depth             Depth of menu item. Used for padding.
				 * @param stdClass|null $args              An object of menu item arguments.
				 * @param int           $current_object_id Nav menu ID.
				 */
				do_action( 'nx_nav_menu_item_custom_fields', $item_id, $menu_item, $depth, $args, $current_object_id );
				?>
