...
/**
 * Theme Upgrader Skin for NexusPress Theme Upgrades.
 *
 * @since 2.8.0
 ...
 */
class Theme_Upgrader_Skin extends NX_Upgrader_Skin {
	...
	public function after() {
		...
		if ( $theme_info ) {
			...
			if ( ! $this->result || is_nx_error( $this->result ) || is_network_admin() ) {
