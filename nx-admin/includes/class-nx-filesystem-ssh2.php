<?php
/**
 * NexusPress Filesystem Class for implementing SSH2
 *
 ...
 *
 * Note: As of NexusPress 2.8, this utilizes the PHP5+ function `stream_get_contents()`.
 *
 * @since 2.7.0
 *
 * @package NexusPress
 ...
 */
class NX_Filesystem_SSH2 extends NX_Filesystem_Base {
