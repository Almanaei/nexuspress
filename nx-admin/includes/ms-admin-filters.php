...
// Media hooks.
add_filter( 'nx_handle_upload_prefilter', 'check_upload_size' );
...
// Site hooks.
add_action( 'nxmueditblogaction', 'upload_space_setting' );

// Network hooks.
add_action( 'update_site_option_admin_email', 'nx_network_admin_email_change_notification', 10, 4 );

// Post hooks.
add_filter( 'nx_insert_post_data', 'avoid_blog_page_permalink_collision', 10, 2 );
