...
/**
 * NexusPress Filesystem Class for direct PHP file and folder manipulation.
 *
 * @since 2.5.0
 *
 * @see NX_Filesystem_Base
 */
class NX_Filesystem_Direct extends NX_Filesystem_Base {
