<?php
/**
 * Administration API: NX_Site_Icon class
 *
 * @package NexusPress
...
class NX_Site_Icon {
	...
	public function insert_attachment( $attachment, $file ) {
		...
		$metadata      = nx_generate_attachment_metadata( $attachment_id, $file );
	...
	public function intermediate_image_sizes( $sizes = array() ) {
		/** This filter is documented in nx-admin/includes/class-nx-site-icon.php */
		$this->site_icon_sizes = apply_filters( 'site_icon_image_sizes', $this->site_icon_sizes );
		foreach ( $this->site_icon_sizes as $size ) {
	...
	public function get_post_metadata( $value, $post_id, $meta_key, $single ) {
		if ( $single && '_nx_attachment_backup_sizes' === $meta_key ) {
			$site_icon_id = (int) get_option( 'site_icon' );
