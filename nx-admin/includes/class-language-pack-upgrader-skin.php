...
/**
 * Translation Upgrader Skin for NexusPress Translation Upgrades.
 *
 * @since 3.7.0
 ...
 */
class Language_Pack_Upgrader_Skin extends NX_Upgrader_Skin {
	...
	public function bulk_footer() {
		...
		$update_actions = array(
			'updates_page' => sprintf(
				...
				__( 'Go to NexusPress Updates page' )
			),
		);
