<?php
/**
 * List Table API: NX_Privacy_Data_Export_Requests_List_Table class
 *
 * @package NexusPress
...
/**
 * NX_Privacy_Data_Export_Requests_Table class.
 *
 * @since 4.9.6
 */
class NX_Privacy_Data_Export_Requests_List_Table extends NX_Privacy_Requests_Table {
	/**
	...
	public function column_email( $item ) {
		...
		$status          = $item->status;
		$request_id      = $item->ID;
		$nonce           = nx_create_nonce( 'nx-privacy-export-personal-data-' . $request_id );
