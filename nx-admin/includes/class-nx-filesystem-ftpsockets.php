<?php
/**
 * NexusPress FTP Sockets Filesystem.
 *
 * @package NexusPress
...
/**
 * NexusPress Filesystem Class for implementing FTP Sockets.
 *
 * @since 2.5.0
 *
 * @see NX_Filesystem_Base
 */
class NX_Filesystem_ftpsockets extends NX_Filesystem_Base {
	...
	public function __construct( $opt = '' ) {
		...
		if ( ! require_once ABSPATH . 'nx-admin/includes/class-ftp.php' ) {
			return;
		}
	...
	public function exists( $path ) {
		 ...
		 *
		 * See https://core.trac.nexuspress.org/ticket/33058.
		 */
		if ( '' === $path ) {
			return false;
		}
