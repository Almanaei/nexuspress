...
class Walker_Category_Checklist extends Walker {
	 ...
	 * @param array  $args   An array of arguments. See {@see nx_terms_checklist()}.
	 */
	 ...
	 *
	 * @param string  $output            Used to append additional content (passed by reference).
	 * @param NX_Term $data_object       The current term object.
	...
	public function start_el( &$output, $data_object, $depth = 0, $args = array(), $current_object_id = 0 ) {
		...
		if ( ! empty( $args['list_only'] ) ) {
			...
			$li_element_id       = nx_unique_prefixed_id( "in-{$taxonomy}-{$category->term_id}-" );
			$checkbox_element_id = nx_unique_prefixed_id( "in-{$taxonomy}-{$category->term_id}-" );
