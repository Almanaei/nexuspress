	...
	array(
		...
		'content' => '<p>' . __( 'This screen contains the settings that affect the display of your content.' ) . '</p>' .
			...
			'<p>' . sprintf(
				...
				__( 'https://developer.nexuspress.org/advanced-administration/nexuspress/feeds/' )
			) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://nexuspress.org/documentation/article/settings-reading-screen/">Documentation on Reading Settings</a>' ) . '</p>' .
...
<ul>
	...
	if ( get_option( 'nx_page_for_privacy_policy' ) === get_option( 'page_for_posts' ) || get_option( 'nx_page_for_privacy_policy' ) === get_option( 'page_on_front' ) ) :
		nx_admin_notice(
