...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://nexuspress.org/documentation/article/settings-media-screen/">Documentation on Media Settings</a>' ) . '</p>' .
...
<?php
/**
 * @global array $nx_settings
 */
if ( isset( $GLOBALS['nx_settings']['media']['embeds'] ) ) :
	?>
...
<p class="description">
		<?php
		/* translators: %s: nx-content/uploads */
		printf( __( 'Default is %s' ), '<code>nx-content/uploads</code>' );
		?>
</p>
</td>
</tr>
