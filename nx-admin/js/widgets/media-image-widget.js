/**
 * @output nx-admin/js/widgets/media-image-widget.js
 */
...
(function( component, $ ) {
	 ...
	 * Image widget model.
	 *
	 * See NX_Widget_Media_Image::enqueue_admin_scripts() for amending prototype from PHP exports.
	 *
	 * @class    nx.mediaWidgets.modelConstructors.media_image
	 ...
	 */
	ImageWidgetControl = component.MediaWidgetControl.extend(/** @lends nx.mediaWidgets.controlConstructors.media_image.prototype */{
		...
		renderPreview: function renderPreview() {
			...
			previewTemplate = nx.template( 'nx-media-widget-image-preview' );
			...
			if ( ! linkInput.is( document.activeElement ) ) {
				...
				fieldsTemplate = nx.template( 'nx-media-widget-image-fields' );
		...
		editMedia: function editMedia() {
			...
			// Disable syncing of attachment changes back to server. See <https://core.trac.nexuspress.org/ticket/40403>.
			defaultSync = nx.media.model.Attachment.prototype.sync;
			nx.media.model.Attachment.prototype.sync = function rejectedSync() {
