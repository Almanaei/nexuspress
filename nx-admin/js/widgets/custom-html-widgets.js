/**
 * @output nx-admin/js/widgets/custom-html-widgets.js
 */
...
/**
 * @namespace nx.customHtmlWidget
 * @memberOf nx
 */
nx.customHtmlWidgets = ( function( $ ) {
	'use strict';
	...
	component.CustomHtmlWidgetControl = Backbone.View.extend(/** @lends nx.customHtmlWidgets.CustomHtmlWidgetControl.prototype */{
		 ...
		 * Text widget control.
		 *
		 * @constructs nx.customHtmlWidgets.CustomHtmlWidgetControl
		...
		initialize: function initialize( options ) {
			...
			control.$el.html( nx.template( 'widget-custom-html-control-fields' )( { codeEditorDisabled: component.codeEditorSettings.disabled } ) );
		...
		updateErrorNotice: function( errorAnnotations ) {
			...
			if ( nx.customize && nx.customize.has( control.customizeSettingId ) ) {
				customizeSetting = nx.customize( control.customizeSettingId );
				customizeSetting.notifications.remove( 'htmlhint_error' );
				if ( 0 !== errorAnnotations.length ) {
					customizeSetting.notifications.add( 'htmlhint_error', new nx.customize.Notification( 'htmlhint_error', {
						message: message,
						type: 'error'
					} ) );
				}
		...
		initializeEditor: function initializeEditor() {
			...
			control.editor = nx.codeEditor.initialize( control.fields.content, settings );
	 ...
	 *
	 * @alias nx.customHtmlWidgets.widgetControls
	 *
	 * @type {Object.<string, nx.textWidgets.CustomHtmlWidgetControl>}
	 */
	 ...
	 *
	 * @alias nx.customHtmlWidgets.handleWidgetAdded
	 *
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		renderWhenAnimationDone = function() {
			if ( ! ( nx.customize ? widgetContainer.parent().hasClass( 'expanded' ) : widgetContainer.hasClass( 'open' ) ) ) { // Core merge: The nx.customize condition can be eliminated with this change being in core: https://github.com/xnx/nexuspress-develop/pull/247/commits/5322387d
	 ...
	 *
	 * @alias nx.customHtmlWidgets.setupAccessibleMode
	 *
	 * @return {void}
	 */
	 ...
	 *
	 * @alias nx.customHtmlWidgets.handleWidgetUpdated
	 *
	 * @param {jQuery.Event} event - Event.
	 * @param {jQuery}       widgetContainer - Widget container element.
	 * @return {void}
	 ...
	 *
	 * @alias nx.customHtmlWidgets.init
	 *
