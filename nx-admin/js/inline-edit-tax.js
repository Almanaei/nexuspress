 ...
 *
 * @output nx-admin/js/inline-edit-tax.js
 */
...
window.inlineEditTax = {
	...
	init : function() {
		...
		t.type = $('#the-list').attr('data-nx-lists').substr(5);
		t.what = '#'+t.type+'-';
	...
	edit : function(id) {
		...
		$( 'td', editRow ).attr( 'colspan', $( 'th:visible, td:visible', '.nx-list-table.widefat:first thead' ).length );
