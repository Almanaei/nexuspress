/**
 * @output nx-admin/js/password-strength-meter.js
 */
...
(function($){
		...
		userInputBlacklist : function() {
			window.console.log(
				sprintf(
					...
					'nx.passwordStrength.userInputBlacklist()',
					'5.5.0',
					'nx.passwordStrength.userInputDisallowedList()'
				)
			);

			return nx.passwordStrength.userInputDisallowedList();
		},
	 ...
	 *
	 * @since 2.5.0
	 * @deprecated 3.7.0 Use nx.passwordStrength.meter instead.
	 *
	 * @global
	 *
	 * @type {nx.passwordStrength.meter}
	 */
	window.passwordStrength = nx.passwordStrength.meter;
})(jQuery);
