/**
 * @output nx-admin/js/custom-background.js
 */
...
(function($) {
	$( function() {
		...
		/**
		 * Instantiates the NexusPress color picker and binds the change and clear events.
		 *
		 * @since 3.5.0
		 *
		 * @return {void}
		 */
		$('#background-color').nxColorPicker({
		...
		$('#choose-from-library-link').on( 'click', function( event ) {
			...
			frame = nx.media.frames.customBackground = nx.media({
