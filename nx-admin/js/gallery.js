/**
 * @output nx-admin/js/gallery.js
 */

/* global unescape, getUserSetting, setUserSetting, nxgallery, tinymce */
...
window.nxgallery = {
	...
	setup : function() {
		...
		if ( t.el.nodeName !== 'IMG' || ! ed.dom.hasClass(t.el, 'nxGallery') ) {
			if ( ( g = ed.dom.select('img.nxGallery') ) && g[0] ) {
				t.el = g[0];
			} else {
