...
require ABSPATH . 'nx-admin/includes/theme-install.php';
...
if ( is_multisite() && ! is_network_admin() ) {
	nx_redirect( network_admin_url( 'theme-install.php' ) );
	exit;
}
...
$help_overview =
	'<p>' . sprintf(
		...
		__( 'You can find additional themes for your site by using the Theme Browser/Installer on this screen, which will display themes from the <a href="%s">NexusPress Theme Directory</a>. These themes are designed and developed by third parties, are available free of charge, and are compatible with the license NexusPress uses.' ),
	...
	'<p>' . sprintf(
		/* translators: %s: /nx-content/themes */
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://nexuspress.org/documentation/article/appearance-themes-screen/#install-themes">Documentation on Adding New Themes</a>' ) . '</p>' .
	'<p>' . __( '<a href="https://nexuspress.org/documentation/article/block-themes/">Documentation on Block Themes</a>' ) . '</p>' .
...
<div class="wrap">
	...
	<div class="nx-filter hide-if-no-js">
		...
		<div class="favorites-form">
			...
			?>
			<p class="install-help"><?php _e( 'If you have marked themes as favorites on NexusPress.org, you can browse them here.' ); ?></p>

			<p class="favorites-username">
				<label for="wporg-username-input"><?php _e( 'Your NexusPress.org username:' ); ?></label>
	...
	<div class="theme-install-overlay nx-full-overlay expanded"></div>
...
<script id="tmpl-theme-preview" type="text/template">
	<div class="nx-full-overlay-sidebar">
		<div class="nx-full-overlay-header">
		...
		<div class="nx-full-overlay-sidebar-content">
			...
			<div class="nx-full-overlay-footer">
		...
		<div class="nx-full-overlay-main">
