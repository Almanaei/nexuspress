...
if ( $_POST ) {
	if ( isset( $_POST['html-upload'] ) && ! empty( $_FILES ) ) {
		...
		if ( is_nx_error( $upload_id ) ) {
			nx_die( $upload_id );
		}
	}
	nx_redirect( admin_url( 'upload.php' ) );
	exit;
}
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://nexuspress.org/documentation/article/media-add-new-screen/">Documentation on Uploading Media Files</a>' ) . '</p>' .
