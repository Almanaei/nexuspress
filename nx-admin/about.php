...
/* translators: Page title of the About NexusPress page in the admin. */
$title = _x( 'About', 'page title' );

list( $display_version ) = explode( '-', get_bloginfo( 'version' ) );

$release_notes_url = sprintf(
	/* translators: %s: NexusPress version number. */
	__( 'https://nexuspress.org/documentation/nexuspress-version/version-%s/' ),
	'6-7'
);

$field_guide_url = sprintf(
	/* translators: %s: NexusPress version number. */
	__( 'https://make.nexuspress.org/core/nexuspress-%s-field-guide/' ),
	'6-7'
);
...
?>
	<div class="wrap about__container">
		...
		<div class="about__section changelog has-subtle-background-color">
			<div class="column">
				...
				<p>
					<?php
					printf(
						/* translators: 1: NexusPress version number, 2: Plural number of bugs. */
						_n(
					...
					printf(
						...
						sprintf(
							...
							esc_url( __( 'https://nexuspress.org/support/nexuspress-version/version-%s/' ) ),
		...
		<div class="about__section">
			<div class="column">
				<h2>
					...
					printf(
						/* translators: %s: Version number. */
						__( 'Welcome to NexusPress %s' ),
						$display_version
					);
					?>
				</h2>
				<p class="is-subheading">
					<?php _e( 'NexusPress 6.7 debuts the modern Twenty Twenty-Five theme, offering ultimate design flexibility for any blog at any scale. Control your site typography like never before with new font management features. The new Zoom Out feature lets you design your site with a macro view, stepping back from the details to bring the big picture to life.' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			...
			<div class="column is-vertically-aligned-center">
				<div class="about__image">
					<img src="https://s.nx.org/images/core/6.7/feature-tt5-2.webp" alt="" height="436" width="436" />
				</div>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column is-vertically-aligned-center">
				<div class="about__image">
					<img src="https://s.nx.org/images/core/6.7/feature-zoom-2.webp" alt="" height="436" width="436" />
				</div>
			</div>
			<div class="column is-vertically-aligned-center">
		...
		<div class="about__section has-2-columns">
			...
			<div class="column is-vertically-aligned-center">
				<div class="about__image">
					<img src="https://s.nx.org/images/core/6.7/feature-block-bindings-2.webp" alt="" height="436" width="436" />
				</div>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column is-vertically-aligned-center">
				<div class="about__image">
					<img src="https://s.nx.org/images/core/6.7/feature-font-presets-2.png" alt="" height="436" width="436" />
				</div>
			</div>
			<div class="column is-vertically-aligned-center">
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p><?php _e( 'NexusPress 6.7 delivers important performance updates, including faster pattern loading, optimized previews in the data views component, improved PHP 8+ support and removal of deprecated code, auto sizes for lazy-loaded images, and more efficient tag processing in the HTML API.' ); ?></p>
			</div>
			<div class="column">
				<div class="about__image">
					<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
				...
				<p><?php _e( '65+ accessibility fixes and enhancements focus on foundational aspects of the NexusPress experience, from improving user interface components and keyboard navigation in the Editor, to an accessible heading on NexusPress login screens and clearer labeling throughout.' ); ?></p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns is-wider-left is-feature" style="background-color:var(--background);border-radius:var(--border-radius);">
			...
			<div class="column">
				<p>
					...
					printf(
						/* translators: %s: Version number. */
						__( 'For a comprehensive overview of all the new features and enhancements in NexusPress %s, please visit the feature-showcase website.' ),
						$display_version
					);
					?>
				</p>
			...
			<div class="column aligncenter">
				<div class="about__image">
					<a href="<?php echo esc_url( __( 'https://nexuspress.org/download/releases/6-7/' ) ); ?>" class="button button-primary button-hero"><?php _e( 'See everything new' ); ?></a>
				</div>
			</div>
		</div>
		...
		<div class="about__section has-3-columns">
			...
			<div class="column is-vertically-aligned-center" style="grid-column-end:span 2">
				<h3>
					...
					printf(
						/* translators: %s: Version number. */
						__( 'Learn more about NexusPress %s' ),
						$display_version
					);
					?>
				</h3>
				<p>
					<?php
					printf(
						/* translators: 1: Learn NexusPress link, 2: Workshops link. */
						__( '<a href="%1$s">Learn NexusPress</a> is a free resource for new and experienced NexusPress users. Learn is stocked with how-to videos on using various features in NexusPress, <a href="%2$s">interactive workshops</a> for exploring topics in-depth, and lesson plans for diving deep into specific areas of NexusPress.' ),
						'https://learn.nexuspress.org/',
						'https://learn.nexuspress.org/online-workshops/'
					);
					?>
				</p>
			</div>
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p>
					...
					printf(
						/* translators: %s: NexusPress version number. */
						__( 'Read the NexusPress %s Release Notes for information on installation, enhancements, fixed issues, release contributors, learning resources, and the list of file changes.' ),
						'6.7'
					);
					?>
				</p>
			...
			<div class="column">
				...
				<p>
					...
					printf(
						/* translators: %s: NexusPress version number. */
						__( 'Explore the NexusPress %s Field Guide. Learn about the changes in this release with detailed developer notes to help you build with NexusPress.' ),
						'6.7'
					);
					?>
				</p>
...
/* translators: 1: NexusPress version number, 2: Plural number of bugs. Singular security issue. */
_n_noop(
	'<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.',
	'<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.'
);

/* translators: 1: NexusPress version number, 2: Plural number of bugs. More than one security issue. */
_n_noop(
...
/* translators: 1: NexusPress version number, 2: Link to update NexusPress */
__( 'Important! Your version of NexusPress (%1$s) is no longer supported, you will not receive any security updates for your website. To keep your site secure, please <a href="%2$s">update to the latest version of NexusPress</a>.' );

/* translators: 1: NexusPress version number, 2: Link to update NexusPress */
__( 'Important! Your version of NexusPress (%1$s) will stop receiving security updates in the near future. To keep your site secure, please <a href="%2$s">update to the latest version of NexusPress</a>.' );

/* translators: %s: The major version of NexusPress for this branch. */
__( 'This is the final release of NexusPress %s' );

/* translators: The localized NexusPress download URL. */
__( 'https://nexuspress.org/download/' );
