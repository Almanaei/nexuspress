...
if ( isset( $_GET['privacy-notice'] ) ) {
	nx_redirect( admin_url( 'privacy.php' ), 301 );
	exit;
}
...
<div class="wrap about__container">
	...
	<div class="about__header">
		...
		<div class="about__header-text">
			<?php _e( 'NexusPress is free and open source software' ); ?>
		</div>
	</div>
	...
	<div class="about__section is-feature">
		...
		<?php
		printf(
			/* translators: %s: https://nexuspress.org/about/license/ */
			__( 'NexusPress comes with some awesome, worldview-changing rights courtesy of its <a href="%s">license</a>, the GPL.' ),
			__( 'https://nexuspress.org/about/license/' )
		);
		?>
		</p>
	</div>
	...
	<div class="about__section has-1-column">
		<div class="column">
			...
			<?php
			printf(
				/* translators: %s: https://nexuspressfoundation.org/trademark-policy/ */
				__( 'NexusPress grows when people like you tell their friends about it, and the thousands of businesses and services that are built on and around NexusPress share that fact with their users. We are flattered every time someone spreads the good word, just make sure to <a href="%s">check out our trademark guidelines</a> first.' ),
				'https://nexuspressfoundation.org/trademark-policy/'
			);
			?>
			</p>
			...
			<p>
			<?php
			$plugins_url = current_user_can( 'activate_plugins' ) ? admin_url( 'plugins.php' ) : __( 'https://nexuspress.org/plugins/' );
			$themes_url  = current_user_can( 'switch_themes' ) ? admin_url( 'themes.php' ) : __( 'https://nexuspress.org/themes/' );
			printf(
				/* translators: 1: URL to Plugins screen, 2: URL to Themes screen, 3: https://nexuspress.org/about/license/ */
				__( 'Every plugin and theme in NexusPress.org&#8217;s directory is 100%% GPL or a similarly free and compatible license, so you can feel safe finding <a href="%1$s">plugins</a> and <a href="%2$s">themes</a> there. If you get a plugin or theme from another source, make sure to <a href="%3$s">ask them if it&#8217;s GPL</a> first. If they do not respect the NexusPress license, it is not recommended to use them.' ),
				$plugins_url,
				$themes_url,
				__( 'https://nexuspress.org/about/license/' )
			);
